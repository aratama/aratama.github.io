  ...
  var $$eval = (function () {
      ...
      var updateServerValue = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))((function () {
              ...
              throw new Error("Failed pattern match at SyncTicker.UI line 214, column 17 - line 221, column 27: " + [ v.firebase.constructor.name ]);
          })());
      });
      return function (v) {
          if (v instanceof SyncTicker_Type.Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                  ...
                  var v2 = DOM_HTML_Window.history(v1)();
                  var v3 = DOM_HTML_Window.location(v1)();
                  return DOM_HTML_Location.search(v3)();
              }))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      var v2 = Data_String_Regex.regex("^\\?id=([a-zA-Z0-9]*?)$")(Data_String_Regex_Flags.noFlags);
                      if (v2 instanceof Data_Either.Left) {
                          return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.log("regex error"));
                      };
                      if (v2 instanceof Data_Either.Right) {
                          return Data_Maybe.fromMaybe(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit))(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_String_Regex.match(v2.value0)(v1))(function (v3) {
                              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(v3)(1))(function (v4) {
                                  return Control_Bind.bind(Data_Maybe.bindMaybe)(v4)(function (v5) {
                                      return new Data_Maybe.Just(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v6) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                              ...
                                              return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.log("Initial Timer ID: " + v5));
                                          });
                                      }));
                                  });
                              });
                      ...
                      throw new Error("Failed pattern match at SyncTicker.UI line 49, column 9 - line 59, column 68: " + [ v2.constructor.name ]);
                  })())(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          ...
                          })(Data_Maybe.Nothing.value)))(function (v3) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                  var $77 = {};
                                  for (var $78 in v2) {
                                  ...
                                  $77.firebase = new Data_Maybe.Just(v3);
                                  return $77;
                              })()))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateTimerID(v2.timerID))(function () {
          ...
          if (v instanceof SyncTicker_Type.Receive) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      if (v.value0 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Now.now))(function (v2) {
                              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                  ...
                                  $88.serverState = v.value0;
                                  $88.count = v.value0.value0.count;
                                  $88.max = v.value0.value0.max;
                                  $88.active = (function () {
                      ...
                      throw new Error("Failed pattern match at SyncTicker.UI line 81, column 9 - line 92, column 18: " + [ v.value0.constructor.name ]);
                  })())(function () {
          ...
          if (v instanceof SyncTicker_Type.Backward) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      ...
                      $96.count = Data_Ord.max(Data_Ord.ordInt)(-5999 | 0)(Data_Ord.min(Data_Ord.ordInt)(5999)(v1.max));
                      $96.active = Data_Maybe.Nothing.value;
                      return $96;
                  })()))(function () {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Now.now))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          ...
                          $102.active = new Data_Maybe.Just({
                              start: v2, 
                              count: v1.count
                          });
                          return $102;
          ...
          if (v instanceof SyncTicker_Type.Pause) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      ...
                      $107.active = Data_Maybe.Nothing.value;
                      return $107;
                  })()))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateServerValue)(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
          ...
          if (v instanceof SyncTicker_Type.Tick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at SyncTicker.UI line 130, column 9 - line 137, column 33: " + [ v1.active.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          ...
          if (v instanceof SyncTicker_Type.Adjust) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at SyncTicker.UI line 142, column 9 - line 157, column 43: " + [ v1.active.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))((function () {
                          ...
                          throw new Error("Failed pattern match at SyncTicker.UI line 167, column 17 - line 173, column 23: " + [ v1.firebase.constructor.name ]);
                      })()))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                      });
                  });
          ...
          throw new Error("Failed pattern match at SyncTicker.UI line 38, column 8 - line 179, column 18: " + [ v.constructor.name ]);
      };
  })();
...
(function(exports) {
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(SyncTicker_UI.ui)("cats")(v))(function (v1) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(v1.query(Halogen_Query.action(SyncTicker_Type.Initialize.create)))(function () {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Timer.setInterval(200)(Halogen_Aff_Util.runHalogenAff(v1.query(Halogen_Query.action(SyncTicker_Type.Tick.create))))))(function (v2) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
              });
          });
      });

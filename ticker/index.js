...
(function(exports) {
  ...
  var showEventType = function (v) {
      ...
      throw new Error("Failed pattern match at Web.Firebase4.Type line 67, column 17 - line 75, column 1: " + [ v.constructor.name ]);
  };
  exports["Value"] = Value;
  exports["ChildAdded"] = ChildAdded;
  exports["ChildChanged"] = ChildChanged;
  exports["ChildRemoved"] = ChildRemoved;
  exports["ChildMoved"] = ChildMoved;
  exports["showEventType"] = showEventType;
})(PS["Web.Firebase4.Type"] = PS["Web.Firebase4.Type"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Monad_Eff_Console = PS["Control.Monad.Eff.Console"];
  ...
  var SyncTicker_Server = PS["SyncTicker.Server"];
  var Web_Firebase4_Type = PS["Web.Firebase4.Type"];        
  ...
  var Menu = (function () {
      function Menu(value0) {
          this.value0 = value0;
      };
      Menu.create = function (value0) {
          return new Menu(value0);
      };
      return Menu;
  })();
  var Backward = (function () {
      function Backward(value0) {
          this.value0 = value0;
      };
      Backward.create = function (value0) {
          return new Backward(value0);
      };
      return Backward;
  })();
  var Play = (function () {
  ...
  var Adjust = (function () {
      function Adjust(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Adjust.create = function (value0) {
          return function (value1) {
              return new Adjust(value0, value1);
          };
      };
      return Adjust;
  })();
  var Help = (function () {
      function Help(value0) {
          this.value0 = value0;
      };
      Help.create = function (value0) {
          return new Help(value0);
      };
      return Help;
  })();
  var CloseHelp = (function () {
      function CloseHelp(value0) {
          this.value0 = value0;
      };
      CloseHelp.create = function (value0) {
          return new CloseHelp(value0);
      };
      return CloseHelp;
  })();
  ...
  var UpdateTimerID = (function () {
      function UpdateTimerID(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      UpdateTimerID.create = function (value0) {
          return function (value1) {
              return new UpdateTimerID(value0, value1);
          };
      };
  ...
  exports["UpdateTimerID"] = UpdateTimerID;
})(PS["SyncTicker.Type"] = PS["SyncTicker.Type"] || {});
(function(exports) {
    "use strict";
...
})(PS["Web.Firebase4.App.App"] = PS["Web.Firebase4.App.App"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var $foreign = PS["Web.Firebase4.App.App"];
  var Control_Monad_Aff = PS["Control.Monad.Aff"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Control_Monad_Eff_Exception = PS["Control.Monad.Eff.Exception"];
  var Data_Unit = PS["Data.Unit"];
...
})(PS["Web.Firebase4.Database.Database"] = PS["Web.Firebase4.Database.Database"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var $foreign = PS["Web.Firebase4.Database.Database"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Web_Firebase4_Type = PS["Web.Firebase4.Type"];
...
})(PS["Web.Firebase4.Database.Reference"] = PS["Web.Firebase4.Database.Reference"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var $foreign = PS["Web.Firebase4.Database.Reference"];
  var Control_Monad_Aff = PS["Control.Monad.Aff"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Control_Monad_Eff_Exception = PS["Control.Monad.Eff.Exception"];
  var Data_Foreign = PS["Data.Foreign"];
  ...
  var on = function (eventType) {
      return function (reject) {
          return function (resolve) {
              return $foreign._on(Web_Firebase4_Type.showEventType(eventType))(reject)(resolve);
          };
      };
  };
  exports["on"] = on;
...
})(PS["Web.Firebase4.Database.Snapshot"] = PS["Web.Firebase4.Database.Snapshot"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var $foreign = PS["Web.Firebase4.Database.Snapshot"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Data_Foreign = PS["Data.Foreign"];
  var Prelude = PS["Prelude"];
  var Web_Firebase4_Type = PS["Web.Firebase4.Type"];
...
(function(exports) {
  ...
  var Prelude = PS["Prelude"];
  var SyncTicker_Server = PS["SyncTicker.Server"];
  var SyncTicker_Type = PS["SyncTicker.Type"];
  var Web_Firebase4_App_App = PS["Web.Firebase4.App.App"];
  var Web_Firebase4_Database_Database = PS["Web.Firebase4.Database.Database"];
  var Web_Firebase4_Database_Reference = PS["Web.Firebase4.Database.Reference"];
  var Web_Firebase4_Database_Snapshot = PS["Web.Firebase4.Database.Snapshot"];
  var Web_Firebase4_Type = PS["Web.Firebase4.Type"];        
  var unsubscribeValue = function (timerID) {
      return function (firebase) {
          return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase4_App_App.database(firebase))(Web_Firebase4_Database_Database.ref("timers/" + timerID)))(Web_Firebase4_Database_Reference.off);
      };
  };
  var subscribeValue = function (dictMonadAff) {
      return function (timerID) {
          return function (firebase) {
              return function (f) {
                  var onValue = function (snapshot) {
                      return new Data_Maybe.Just(f(snapshot)(Halogen_Query_EventSource.Listening.value));
                  };
                  var addListener = function (resolve) {
                      return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase4_App_App.database(firebase))(Web_Firebase4_Database_Database.ref("timers/" + timerID)))(Web_Firebase4_Database_Reference.on(Web_Firebase4_Type.Value.value)(Control_Monad_Eff_Console.logShow(Control_Monad_Eff_Exception.showError))(function (snapshot) {
                          var foreignValue = Web_Firebase4_Database_Snapshot.val(snapshot);
                          return resolve((function () {
                              var $1 = Data_Foreign.isNull(foreignValue);
                              if ($1) {
                                  return Data_Maybe.Nothing.value;
                              };
                              return new Data_Maybe.Just(Data_Foreign.unsafeFromForeign(foreignValue));
                          })());
                      })));
                  };
                  return Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.eventSource(dictMonadAff)(addListener)(onValue));
              };
          };
      };
  };
  var setValue = function (timerID) {
      return function (value) {
          return function (firebase) {
              return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase4_App_App.database(firebase))(Web_Firebase4_Database_Database.ref("timers/" + timerID)))(Web_Firebase4_Database_Reference.set(Data_Foreign.toForeign(value)));
          };
      };
  };
  exports["setValue"] = setValue;
  exports["subscribeValue"] = subscribeValue;
  exports["unsubscribeValue"] = unsubscribeValue;
})(PS["SyncTicker.Client"] = PS["SyncTicker.Client"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  ...
  exports["root"] = root;
  exports["timerIDClass"] = timerIDClass;
  exports["triangle"] = triangle;
  exports["up"] = up;
  exports["usage"] = usage;
})(PS["SyncTicker.Classes"] = PS["SyncTicker.Classes"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Alt = PS["Control.Alt"];
  ...
  var padLeft = function (c) {
      return function (len) {
          return function (str) {
              var prefix = Data_String.fromCharArray(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(len - Data_String.length(str) | 0)(c));
              return prefix + str;
          };
      };
  }; 
  ...
  var formatNumber = new Format(function (v) {
      return function (v1) {
          ...
          var usedDelimiter = Data_Maybe.fromMaybe(".")(v.value0.decimalMark);
          ...
          var num = (function () {
              ...
              throw new Error("Failed pattern match at Text.Format line 145, column 12 - line 149, column 40: " + [ v.value0.precision.constructor.name ]);
          })();
          var numAbsStr$prime$prime = Data_Show.show(Data_Show.showNumber)($$Math.abs(num));
          var numAbsStr$prime = (function () {
              if (v.value0.decimalMark instanceof Data_Maybe.Nothing) {
                  return numAbsStr$prime$prime;
              };
              if (v.value0.decimalMark instanceof Data_Maybe.Just) {
                  return Data_String.replace(".")(Data_String.singleton(v.value0.decimalMark.value0))(numAbsStr$prime$prime);
              };
              throw new Error("Failed pattern match at Text.Format line 154, column 19 - line 156, column 92: " + [ v.value0.decimalMark.constructor.name ]);
          })();
          var paddedZeros = function (p) {
              var d = Data_String.length(Data_String.dropWhile(function (v2) {
                  return v2 !== usedDelimiter;
              })(numAbsStr$prime)) - 1 | 0;
              return Data_String.fromCharArray(Data_Unfoldable.replicate(Data_Unfoldable.unfoldableArray)(p - d | 0)("0"));
          };
          var numAbsStr = (function () {
              ...
              throw new Error("Failed pattern match at Text.Format line 157, column 18 - line 159, column 57: " + [ v.value0.precision.constructor.name ]);
          })();
          ...
          if (v.value0.width instanceof Data_Maybe.Just) {
              ...
              return numSgn + padLeft(padChar)(v.value0.width.value0 - Data_String.length(numSgn) | 0)(numAbsStr);
          };
          if (v.value0.width instanceof Data_Maybe.Nothing) {
              return numSgn + numAbsStr;
          };
          throw new Error("Failed pattern match at Text.Format line 135, column 5 - line 142, column 37: " + [ v.value0.width.constructor.name ]);
      };
  });
  var formatInt = new Format(function (v) {
      return function (num) {
          ...
          if (v.value0.width instanceof Data_Maybe.Just) {
              ...
              return numSgn + padLeft(padChar)(v.value0.width.value0 - Data_String.length(numSgn) | 0)(Data_Show.show(Data_Show.showInt)(numAbs));
          };
          if (v.value0.width instanceof Data_Maybe.Nothing) {
              return numSgn + Data_Show.show(Data_Show.showInt)(numAbs);
          };
          throw new Error("Failed pattern match at Text.Format line 111, column 5 - line 118, column 39: " + [ v.value0.width.constructor.name ]);
      };
  });
  var $$default = {
      ...
      decimalMark: Data_Maybe.Nothing.value
  };                            
  var precision = function (digits) {
      return new Properties((function () {
          var $52 = {};
          for (var $53 in $$default) {
              if ({}.hasOwnProperty.call($$default, $53)) {
                  $52[$53] = $$default[$53];
              };
          };
          $52.precision = new Data_Maybe.Just(digits);
          return $52;
      })());
  };
  var signed = new Properties((function () {
      var $55 = {};
      for (var $56 in $$default) {
          if ({}.hasOwnProperty.call($$default, $56)) {
              $55[$56] = $$default[$56];
          };
      };
      $55.signed = new Data_Maybe.Just(true);
      return $55;
  })());
  var width = function (n) {
      return new Properties((function () {
          var $58 = {};
          for (var $59 in $$default) {
              if ({}.hasOwnProperty.call($$default, $59)) {
                  $58[$59] = $$default[$59];
              };
          };
          $58.width = new Data_Maybe.Just(n);
          return $58;
      })());
  };    
  var decimalMark = function ($$char) {
      return new Properties((function () {
          var $64 = {};
          for (var $65 in $$default) {
              if ({}.hasOwnProperty.call($$default, $65)) {
                  $64[$65] = $$default[$65];
              };
          };
          $64.decimalMark = new Data_Maybe.Just($$char);
          return $64;
      })());
  };
  exports["Format"] = Format;
  exports["decimalMark"] = decimalMark;
  exports["format"] = format;
...
(function(exports) {
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];
  var SyncTicker_Classes = PS["SyncTicker.Classes"];
  var SyncTicker_Type = PS["SyncTicker.Type"];
  var Text_Format = PS["Text.Format"];
  var Unsafe_Coerce = PS["Unsafe.Coerce"];        
  var render = function (state) {
      var style = function (str) {
          return Unsafe_Coerce.unsafeCoerce(Halogen_HTML_Core.prop(Halogen_HTML_Core.stringIsProp)("style")(str));
      };
      var icon = function (name) {
          return Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-" + name) ])([  ]);
      };
      var renderHelp = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ SyncTicker_Classes.help, (function () {
          if (state.help) {
              return SyncTicker_Classes.empty;
          };
          return SyncTicker_Classes.hidden;
      })() ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(SyncTicker_Classes.dialog) ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Sync Ticker") ]), Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("\u9060\u9694\u64cd\u4f5c\u53ef\u80fd\u30b9\u30d4\u30fc\u30c1\u30bf\u30a4\u30de\u30fc") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(SyncTicker_Classes.usage) ])([ Halogen_HTML_Elements.h3_([ Halogen_HTML_Core.text("\u4f7f\u3044\u304b\u305f\uff1a") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("\u4ed6\u306e\u30c7\u30d0\u30a4\u30b9\u3068\u30bf\u30a4\u30de\u30fc\u3092\u5171\u6709\u3059\u308b\u306b\u306f\u3001\x0a\u53cc\u65b9\u306b\u540c\u3058\u30bf\u30a4\u30de\u30fcID\u3092\u5165\u529b\u3057\u3066\u304f\u3060\u3055\u3044\u3002\x0a\u8a08\u6e2c\u3059\u308b\u6642\u9593\u3092\u8a2d\u5b9a\u3059\u308b\u306b\u306f\u3001"), icon("fast-backward"), Halogen_HTML_Core.text("\u30dc\u30bf\u30f3\u3067\u30ab\u30a6\u30f3\u30c8\u3092\u30ea\u30bb\u30c3\u30c8\u3057\u3066\u304b\u3089\x0a\u6570\u5b57\u306e\u4e0a\u3092\u30af\u30ea\u30c3\u30af\u3057\u3066\u304f\u3060\u3055\u3044\u3002") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(SyncTicker_Classes.timerIDClass) ])([ Halogen_HTML_Elements.span([  ])([ Halogen_HTML_Core.text("\u30bf\u30a4\u30de\u30fcID") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(state.timerID), Halogen_HTML_Events.onValueInput(function (value) {
          return new Data_Maybe.Just(new SyncTicker_Type.UpdateTimerID(value, Data_Unit.unit));
      }) ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_(SyncTicker_Classes.close), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SyncTicker_Type.CloseHelp.create)) ])([ Halogen_HTML_Core.text((function () {
          if (state.serverState instanceof Data_Maybe.Nothing) {
              return "\u3053\u306e\u30bf\u30a4\u30de\u30fc\u3092\u65b0\u898f\u4f5c\u6210\u3059\u308b";
          };
          if (state.serverState instanceof Data_Maybe.Just) {
              return "\u3053\u306e\u30bf\u30a4\u30de\u30fc\u306b\u63a5\u7d9a\u3059\u308b";
          };
          throw new Error("Failed pattern match at SyncTicker.Render line 135, column 69 - line 138, column 13: " + [ state.serverState.constructor.name ]);
      })()) ]) ]) ]);
      var digit = function (n) {
          return function (shift) {
              var buttonDisabled = (function () {
                  if (state.active instanceof Data_Maybe.Nothing && state.count === state.max) {
                      return SyncTicker_Classes.empty;
                  };
                  return SyncTicker_Classes.disabled;
              })();
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(SyncTicker_Classes.digit) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("number") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(n)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ SyncTicker_Classes.triangle, SyncTicker_Classes.up, buttonDisabled ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SyncTicker_Type.Adjust.create(shift))) ])([ Halogen_HTML_Core.text("\u25b2") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ SyncTicker_Classes.triangle, SyncTicker_Classes.down, buttonDisabled ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SyncTicker_Type.Adjust.create(-shift | 0))) ])([ Halogen_HTML_Core.text("\u25bc") ]) ]);
          };
      };
      var count = Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)(Data_Ord.max(Data_Ord.ordInt)(-5999 | 0)(Data_Ord.min(Data_Ord.ordInt)(5999)(state.count)));
      var minutes = count / 60 | 0;
      var d0 = minutes / 10 | 0;
      var d1 = minutes % 10;
      var seconds = count % 60;
      var d2 = seconds / 10 | 0;
      var d3 = seconds % 10;
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(SyncTicker_Classes.root) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ SyncTicker_Classes.display, (function () {
          var $4 = 0 <= state.count;
          if ($4) {
              return SyncTicker_Classes.empty;
          };
          return SyncTicker_Classes.over;
      })() ]) ])([ digit(d0)(600), digit(d1)(60), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(SyncTicker_Classes.colon) ])([ Halogen_HTML_Core.text(":") ]), digit(d2)(10), digit(d3)(1) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(SyncTicker_Classes.controls) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SyncTicker_Type.Backward.create)), Halogen_HTML_Properties.class_((function () {
          if (state.active instanceof Data_Maybe.Just) {
              return SyncTicker_Classes.disabled;
          };
          if (state.active instanceof Data_Maybe.Nothing && state.count === state.max) {
              return SyncTicker_Classes.disabled;
          ...
          return SyncTicker_Classes.empty;
      })()) ])([ icon("fast-backward") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SyncTicker_Type.Play.create)), Halogen_HTML_Properties.class_((function () {
          if (state.active instanceof Data_Maybe.Just) {
              return SyncTicker_Classes.disabled;
          };
          if (state.active instanceof Data_Maybe.Nothing) {
              return SyncTicker_Classes.empty;
          };
          throw new Error("Failed pattern match at SyncTicker.Render line 44, column 20 - line 46, column 33: " + [ state.active.constructor.name ]);
      })()) ])([ icon("play") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SyncTicker_Type.Pause.create)), Halogen_HTML_Properties.class_((function () {
          if (state.active instanceof Data_Maybe.Just) {
              return SyncTicker_Classes.empty;
          };
          if (state.active instanceof Data_Maybe.Nothing) {
          ...
          throw new Error("Failed pattern match at SyncTicker.Render line 51, column 20 - line 53, column 36: " + [ state.active.constructor.name ]);
      })()) ])([ icon("pause") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SyncTicker_Type.Help.create)) ])([ icon("question") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(SyncTicker_Classes.progress) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(SyncTicker_Classes.bar), style("width: " + (Text_Format.format(Text_Format.formatNumber)(Text_Format.precision(2))((100.0 * Data_Int.toNumber(Data_Ord.max(Data_Ord.ordInt)(0)(state.count))) / Data_Int.toNumber(state.max)) + "%")) ])([  ]) ]), renderHelp ]);
  };
  exports["render"] = render;
})(PS["SyncTicker.Render"] = PS["SyncTicker.Render"] || {});
(function(exports) {
    "use strict";
...
})(PS["Web.Firebase4"] = PS["Web.Firebase4"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var $foreign = PS["Web.Firebase4"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Data_Maybe = PS["Data.Maybe"];
  var Data_Nullable = PS["Data.Nullable"];
  var Web_Firebase4_Type = PS["Web.Firebase4.Type"];        
  var initializeApp = function (config) {
      return function (name) {
          return $foreign._initializeApp(config)(Data_Nullable.toNullable(name));
      };
  };
...
(function(exports) {
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];
  var SyncTicker_Client = PS["SyncTicker.Client"];
  var SyncTicker_Render = PS["SyncTicker.Render"];
  var SyncTicker_Type = PS["SyncTicker.Type"];
  var Web_Firebase4 = PS["Web.Firebase4"];
  var Web_Firebase4_Type = PS["Web.Firebase4.Type"];        
  var $$eval = (function () {
      var updateTimerID = function (timerID) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
              if (v.firebase instanceof Data_Maybe.Just) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(SyncTicker_Client.unsubscribeValue(v.timerID)(v.firebase.value0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.log("unsubscribe " + v.timerID)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(SyncTicker_Client.subscribeValue(Control_Monad_Aff_Class.monadAffAff)(timerID)(v.firebase.value0)(SyncTicker_Type.Receive.create))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Console.log("subscribe " + timerID)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                                      ...
                                      var v2 = DOM_HTML_Window.history(v1)();
                                      var v3 = DOM_HTML_Window.location(v1)();
                                      var v4 = DOM_HTML_Location.origin(v3)();
                                      var v5 = DOM_HTML_Location.pathname(v3)();
                                      var url = v4 + (v5 + ("?id=" + timerID));
                                      return DOM_HTML_History.pushState(Data_Foreign.toForeign({}))("")(url)(v2)();
                                  }))(function () {
      ...
      var updateServerValue = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
              (function () {
                  if (v.firebase instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                  };
                  if (v.firebase instanceof Data_Maybe.Just) {
                      return SyncTicker_Client.setValue(v.timerID)({
                          max: v.max, 
                          count: v.count, 
                          active: Data_Maybe.isJust(v.active)
                      })(v.firebase.value0);
                  };
                  throw new Error("Failed pattern match at SyncTicker.UI line 191, column 13 - line 198, column 31: " + [ v.firebase.constructor.name ]);
              })()();
              return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML.window)(DOM_HTML_Window.localStorage))(DOM_WebStorage_Storage.setItem("syncticker/timerID")(v.timerID))();
          });
      });
      return function (v) {
          if (v instanceof SyncTicker_Type.Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Web_Firebase4.initializeApp({
                  ...
                  })(Data_Maybe.Nothing.value)))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          ...
                          $52.firebase = new Data_Maybe.Just(v2);
                          return $52;
                      })()))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateTimerID(v1.timerID))(function () {
          ...
          if (v instanceof SyncTicker_Type.Receive) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v.value0 instanceof Data_Maybe.Nothing) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $58.serverState = v.value0;
                              return $58;
                          })());
                      };
                      if (v.value0 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Now.now))(function (v2) {
                              return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                  var $63 = {};
                                  for (var $64 in v1) {
                                  ...
                                  $63.serverState = v.value0;
                                  $63.count = v.value0.value0.count;
                                  $63.max = v.value0.value0.max;
                                  $63.active = (function () {
                                      if (v.value0.value0.active) {
                                          return new Data_Maybe.Just({
                                              start: v2, 
                                              count: v.value0.value0.count
                                          });
                                      };
                                      return Data_Maybe.Nothing.value;
                                  })();
                      ...
                      throw new Error("Failed pattern match at SyncTicker.UI line 56, column 9 - line 67, column 18: " + [ v.value0.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          };
          if (v instanceof SyncTicker_Type.Menu) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
          };
          if (v instanceof SyncTicker_Type.Backward) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      var $71 = {};
                      for (var $72 in v1) {
                      ...
                      $71.count = Data_Ord.max(Data_Ord.ordInt)(-5999 | 0)(Data_Ord.min(Data_Ord.ordInt)(5999)(v1.max));
                      $71.active = Data_Maybe.Nothing.value;
                      return $71;
                  })()))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateServerValue)(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                      });
                  });
              });
          };
          if (v instanceof SyncTicker_Type.Play) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Now.now))(function (v2) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          var $77 = {};
          ...
          if (v instanceof SyncTicker_Type.Pause) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      var $82 = {};
                      for (var $83 in v1) {
                      ...
                      $82.active = Data_Maybe.Nothing.value;
                      return $82;
                  })()))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateServerValue)(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
          ...
          if (v instanceof SyncTicker_Type.Help) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      var $87 = {};
                      for (var $88 in v1) {
          ...
          if (v instanceof SyncTicker_Type.Tick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1.active instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Control_Monad_Eff_Now.now))(function (v2) {
                              var v3 = Data_Ring.sub(Data_Time_Duration.ringMilliseconds)(Data_DateTime_Instant.unInstant(v2))(Data_DateTime_Instant.unInstant(v1.active.value0.start));
                              var count$prime = Data_Ord.max(Data_Ord.ordInt)(-5999 | 0)(Data_Ord.min(Data_Ord.ordInt)(5999)(v1.active.value0.count - (Data_Int.floor(v3) / 1000 | 0) | 0));
                              return Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(v1.count !== count$prime)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                  var $95 = {};
                                  for (var $96 in v1) {
                                  ...
                                  $95.count = count$prime;
                                  return $95;
                              })()));
                          });
                      };
                      if (v1.active instanceof Data_Maybe.Nothing) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      };
                      throw new Error("Failed pattern match at SyncTicker.UI line 105, column 9 - line 112, column 33: " + [ v1.active.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
              });
          };
          if (v instanceof SyncTicker_Type.Adjust) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      if (v1.active instanceof Data_Maybe.Just) {
                          var count = Data_Ord.max(Data_Ord.ordInt)(0)(Data_Ord.min(Data_Ord.ordInt)(v1.max)(v1.count + v.value0 | 0));
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              var $104 = {};
                              for (var $105 in v1) {
                              ...
                              return updateServerValue;
                          });
                      };
                      if (v1.active instanceof Data_Maybe.Nothing) {
                          if (v1.count === v1.max) {
                              var count = Data_Ord.max(Data_Ord.ordInt)(0)(Data_Ord.min(Data_Ord.ordInt)(5999)(v1.max + v.value0 | 0));
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                  var $108 = {};
                                  for (var $109 in v1) {
                      ...
                      throw new Error("Failed pattern match at SyncTicker.UI line 117, column 9 - line 132, column 43: " + [ v1.active.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          };
          if (v instanceof SyncTicker_Type.CloseHelp) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      var $114 = {};
                      for (var $115 in v1) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))((function () {
                          if (v1.firebase instanceof Data_Maybe.Nothing) {
                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                          };
                          if (v1.firebase instanceof Data_Maybe.Just) {
                              return SyncTicker_Client.setValue(v1.timerID)({
                                  max: v1.max, 
                                  count: v1.count, 
                                  active: Data_Maybe.isJust(v1.active)
                              })(v1.firebase.value0);
                          };
                          throw new Error("Failed pattern match at SyncTicker.UI line 142, column 17 - line 148, column 23: " + [ v1.firebase.constructor.name ]);
                      })()))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                      });
                  });
          ...
          if (v instanceof SyncTicker_Type.UpdateTimerID) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateTimerID(v.value0))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          throw new Error("Failed pattern match at SyncTicker.UI line 32, column 8 - line 154, column 18: " + [ v.constructor.name ]);
      };
  })();
  var ui = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
      render: SyncTicker_Render.render, 
      "eval": $$eval, 
      initialState: function (timerID) {
          return {
              serverState: Data_Maybe.Nothing.value, 
              timerID: Data_Maybe.fromMaybe("example")(timerID), 
              max: 120, 
              count: 120, 
              active: Data_Maybe.Nothing.value, 
              interval: Data_Maybe.Nothing.value, 
              help: true, 
              firebase: Data_Maybe.Nothing.value
          };
      }, 
      receiver: function (v) {
          return Data_Maybe.Nothing.value;
  ...
  exports["ui"] = ui;
})(PS["SyncTicker.UI"] = PS["SyncTicker.UI"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Prelude = PS["Prelude"];
  var SyncTicker_Type = PS["SyncTicker.Type"];
  var SyncTicker_UI = PS["SyncTicker.UI"];        
  var main = function __do() {
      var v = Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML.window)(DOM_HTML_Window.location))(DOM_HTML_Location.search)();
      var v1 = (function () {
          var v1 = Data_String_Regex.regex("^\\?id=([a-zA-Z0-9]*?)$")(Data_String_Regex_Flags.noFlags);
          if (v1 instanceof Data_Either.Left) {
              return function __do() {
                  Control_Monad_Eff_Console.log("internal error in Main")();
                  return Data_Maybe.Nothing.value;
              };
          };
          if (v1 instanceof Data_Either.Right) {
              var v2 = Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_String_Regex.match(v1.value0)(v))(Data_Function.flip(Data_Array.index)(1)))(Control_Category.id(Control_Category.categoryFn));
              if (v2 instanceof Data_Maybe.Nothing) {
                  return function __do() {
                      var v3 = Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(DOM_HTML.window)(DOM_HTML_Window.localStorage))(DOM_WebStorage_Storage.getItem("syncticker/timerID"))();
                      Control_Monad_Eff_Console.log("regex error or no url query")();
                      Control_Monad_Eff_Console.log("use id from local storage: " + Data_Show.show(Data_Maybe.showMaybe(Data_Show.showString))(v3))();
                      return v3;
                  };
              };
              if (v2 instanceof Data_Maybe.Just) {
                  return function __do() {
                      Control_Monad_Eff_Console.log("Initial Timer ID: " + v2.value0)();
                      return new Data_Maybe.Just(v2.value0);
                  };
              };
              throw new Error("Failed pattern match at SyncTicker.Main line 35, column 26 - line 45, column 36: " + [ v2.constructor.name ]);
          };
          throw new Error("Failed pattern match at SyncTicker.Main line 29, column 16 - line 45, column 36: " + [ v1.constructor.name ]);
      })()();
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v2) {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(SyncTicker_UI.ui)(v1)(v2))(function (v3) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(v3.query(Halogen_Query.action(SyncTicker_Type.Initialize.create)))(function () {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Timer.setInterval(200)(Halogen_Aff_Util.runHalogenAff(v3.query(Halogen_Query.action(SyncTicker_Type.Tick.create))))))(function (v4) {
                      return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
                  });
              });
          });
  ...
  exports["main"] = main;
})(PS["SyncTicker.Main"] = PS["SyncTicker.Main"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Data_Unit = PS["Data.Unit"];
  var SyncTicker_Main = PS["SyncTicker.Main"];
  var SyncTicker_Type = PS["SyncTicker.Type"];        
  var main = SyncTicker_Main.main;
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
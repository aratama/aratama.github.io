...
(function(exports) {var count = 0;
  ...
  exports.onbeforeunload = function(callback){
      return function(){
...
(function(exports) {
  ...
  exports["onbeforeunload"] = $foreign.onbeforeunload;
})(PS["Graphics.Toyger"] = PS["Graphics.Toyger"] || {});
(function(exports) {
  // Generated by psc version 0.9.3
  "use strict";
  ...
  var normalize = function (v) {
      ...
      throw new Error("Failed pattern match at Graphics.Toyger.Matrix line 41, column 1 - line 42, column 96: " + [ v.constructor.name ]);
  };
  exports["absv"] = absv;
  exports["addv"] = addv;
  exports["mulv"] = mulv;
...
(function(exports) {
  ...
  exports["onAuthStateChanged"] = $foreign.onAuthStateChanged;
...
(function(exports) {
  ...
  var chunkSize = 16;
  var main = Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Control_Monad_Aff.launchAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Web_Firebase.initializeApp({
      ...
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase.auth(v))(Web_Firebase.signInAnonymously)))(function () {
          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Toyger.loadImage("grass.png"))(function (v1) {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Toyger.loadImage("player.png"))(function (v2) {
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Toyger.getCanvas("canvas"))(function (v3) {
                      return Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))((function () {
                          ...
                          return function __do() {
                              var v4 = Graphics_Canvas.getContext2D(v3)();
                              var v5 = {
                                  userID: "", 
                                  rotation: defaultRotation, 
                                  player: player, 
                                  players: Data_StrMap.empty
                              };
                              Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase.auth(v))(Web_Firebase.onAuthStateChanged(function (user) {
                                  return function __do() {
                                      v5 = (function (v6) {
                                          var $20 = {};
                                          for (var $21 in v6) {
                                              if (v6.hasOwnProperty($21)) {
                                                  $20[$21] = v6[$21];
                                              };
                                          };
                                          $20.userID = Web_Firebase.uid(user);
                                          return $20;
                                      })(v5);
                                      return Control_Monad_Eff_Console.log("signed-in anonymously to firebase, your user id is " + Web_Firebase.uid(user))();
                                  };
                              }))();
                              Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Data_Function.applyFlipped(v)(Web_Firebase.database))(Web_Firebase.ref("/users")))(Web_Firebase.onValue(function (snap) {
                                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                      var v6 = Web_Firebase.val(snap)();
                                      return v5 = (function (v7) {
                                          var $24 = {};
                                          for (var $25 in v7) {
                                              if (v7.hasOwnProperty($25)) {
                                                  $24[$25] = v7[$25];
                                              };
                                          };
                                          $24.players = Data_Foreign.unsafeFromForeign(v6);
                                          return $24;
                                      })(v5);
                                  });
                              }))();
                              Data_Function.apply(Graphics_Toyger.gameloop)(Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                  var v6 = v5;
                                  var zeroOrOne = function (key) {
                                      return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.maybe(0)(Data_Function["const"](1)))(Graphics_Toyger.getKey(key));
                                  };
                                  var v7 = Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Ring.sub(Data_Ring.ringInt))(zeroOrOne(68)))(zeroOrOne(65))();
                                  var v8 = Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Ring.sub(Data_Ring.ringInt))(zeroOrOne(39)))(zeroOrOne(37))();
                                  var v9 = Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Ring.sub(Data_Ring.ringInt))(zeroOrOne(40)))(zeroOrOne(38))();
                                  var rotation = v6.rotation + Data_Int.toNumber(v7) * 2.0e-2;
                                  var move = Graphics_Toyger_Matrix.mulv(Graphics_Toyger_Matrix.rotationMatrix(-rotation))(Graphics_Toyger_Matrix.normalize(Data_Function.apply(Graphics_Toyger_Matrix.scalev(1.5))(Graphics_Toyger_Matrix.vector(Data_Int.toNumber(v8))(Data_Int.toNumber(v9)))));
                                  var state = (function () {
                                      var $34 = {};
                                      for (var $35 in v6) {
                                          if (v6.hasOwnProperty($35)) {
                                              $34[$35] = v6[$35];
                                          };
                                      };
                                      ...
                                      $34.player = (function () {
                                          var $31 = {};
                                          for (var $32 in v6.player) {
                                              if (v6.player.hasOwnProperty($32)) {
                                                  $31[$32] = v6.player[$32];
                                              };
                                          };
                                          $31.position = Graphics_Toyger_Matrix.addv(v6.player.position)(move);
                                          return $31;
                                      })();
                                      return $34;
                                  })();
                                  Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v8 !== 0 || v9 !== 0))(Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Data_Function.applyFlipped(v)(Web_Firebase.database))(Web_Firebase.ref("/users/" + (state.userID + "/position"))))(Web_Firebase.set(Data_Foreign.toForeign(v6.player.position)))))();
                                  v5 = state;
                                  Graphics_Canvas.clearRect(v4)({
                                      x: 0.0, 
                                      y: 0.0, 
                                      w: 1280.0, 
                                      h: 720.0
                                  })();
                                  return Graphics_Canvas.withContext(v4)(function __do() {
                                      Graphics_Canvas.translate({
                                          translateX: Data_Int.toNumber(screenWidth) * 0.5, 
                                          translateY: Data_Int.toNumber(screenHeight) * 0.5
                                      })(v4)();
                                      var s = Graphics_Toyger_Matrix.scaleMatrix(Graphics_Toyger_Matrix.vector(1.0)(60.0 / 90.0));
                                      var r = Graphics_Toyger_Matrix.rotationMatrix(state.rotation);
                                      var t = Graphics_Toyger_Matrix.translationMatrix(Graphics_Toyger_Matrix.vector(Data_Int.toNumber(squareSize) * -5.0)(Data_Int.toNumber(squareSize) * -5.0));
                                      ...
                                      Graphics_Canvas.withContext(v4)(function __do() {
                                          Graphics_Canvas.transform(Graphics_Toyger_Matrix.runMatrix(m))(v4)();
                                          return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_List.foldableList)(Data_List.range(0)(chunkSize - 1))(function (y) {
                                              return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_List.foldableList)(Data_List.range(0)(chunkSize - 1))(function (x) {
                                                  return Graphics_Canvas.drawImage(v4)(v1)(Data_Function.apply(Data_Int.toNumber)(squareSize * x | 0))(Data_Function.apply(Data_Int.toNumber)(squareSize * y | 0));
                                              });
                                          })();
                                      })();
                                      return Data_Function.apply(Graphics_Canvas.withContext(v4))(Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                          Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_StrMap.foldableStrMap)(state.players)(function (p) {
                                              var d = Data_Function.apply(Graphics_Toyger_Matrix.runVector)(Graphics_Toyger_Matrix.mulv(m)(p.position));
                                              return function __do() {
                                                  Graphics_Canvas.drawImage(v4)(v2)(d.x - Data_Int.toNumber(squareSize) * 0.5)((d.y - Data_Int.toNumber(squareSize)) + 4.0)();
                                                  return Data_Unit.unit;
                                              };
                                          })();
                                          var d = Data_Function.apply(Graphics_Toyger_Matrix.runVector)(Graphics_Toyger_Matrix.mulv(m)(state.player.position));
                                          return Graphics_Canvas.drawImage(v4)(v2)(d.x - Data_Int.toNumber(squareSize) * 0.5)((d.y - Data_Int.toNumber(squareSize)) + 4.0)();
                                      }))();
                                  })();
                              }))();
                              return Data_Function.apply(Graphics_Toyger.onbeforeunload)(Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                  return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Data_Function.applyFlipped(v)(Web_Firebase.database))(Web_Firebase.ref("/users/" + v5.userID)))(Web_Firebase.remove)();
                              }))();
                          };
                      })());
                  });

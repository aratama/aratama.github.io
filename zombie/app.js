...
(function(exports) {
  ...
  /**
 * reverseMatrix :: Matrix -> Maybe Matrix
 * reverseMatrix (Matrix m) = let t = det (Matrix m) in if t == 0 then Nothing
 *       / det (Matrix m)
 */  
...
(function(exports) {
  ...
  var onceAff = function (reference) {
      return Control_Monad_Aff.makeAff(function (reject) {
          return function (resolve) {
              return Web_Firebase.once(resolve)(reference);
          };
      });
  };
                  ...
                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Toyger.loadImage("stand1_front05_man.png"))(function (v4) {
                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Toyger.loadImage("fantasy_zombie.png"))(function (v5) {
                          return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Toyger.loadImage("tree_simple2.png"))(function (v6) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Toyger.loadImage("title.png"))(function (v7) {
                                  return Control_Bind.bind(Control_Monad_Aff.bindAff)(Graphics_Toyger.getCanvas("canvas"))(function (v8) {
                                      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(Graphics_Canvas.getContext2D(v8)))(function (v9) {
                                          return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(function (v10) {
                                              if (v10 instanceof Game_Zombie_Types.Title) {
                                                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(Graphics_Canvas.drawImage(v9)(v7)(0.0)(0.0));
                                              };
                                              if (v10 instanceof Game_Zombie_Types.Loading) {
                                                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                      Graphics_Canvas.setFillStyle("black")(v9)();
                                                      return Graphics_Canvas.fillRect(v9)(Game_Zombie_Constants.screenBounds)();
                                                  });
                                              };
                                              if (v10 instanceof Game_Zombie_Types.Playing) {
                                                  return Data_Function.apply(Graphics_Canvas.withContext(v9))(Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                      Graphics_Canvas.setFillStyle("rgb(6, 4, 25)")(v9)();
                                                      Graphics_Canvas.fillRect(v9)(Game_Zombie_Constants.screenBounds)();
                                                      ...
                                                      var s = Graphics_Toyger_Matrix.scaleMatrix(Graphics_Toyger_Matrix.vector(scale)(scale * 0.6));
                                                      var r = Graphics_Toyger_Matrix.rotationMatrix(v10.value0.rotation);
                                                      var t = Graphics_Toyger_Matrix.translationMatrix(Graphics_Toyger_Matrix.scalev(-1.0)(v10.value0.player.position));
                                                      ...
                                                      Graphics_Canvas.withContext(v9)(function __do() {
                                                          Graphics_Canvas.transform(Graphics_Toyger_Matrix.runMatrix(m))(v9)();
                                                          Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_List.foldableList)(Data_List.range(0)(Game_Zombie_Constants.chunkSize - 1))(function (y) {
                                                              return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_List.foldableList)(Data_List.range(0)(Game_Zombie_Constants.chunkSize - 1))(function (x) {
                                                                  var $34 = Data_StrMap.lookup(Data_Show.show(Data_Show.showInt)((Game_Zombie_Constants.chunkSize * y | 0) + x | 0))(v10.value0.geometry);
                                                                  ...
                                                                  if ($34 instanceof Data_Maybe.Just) {
                                                                      return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
                                                                          var img = (function () {
                                                                              if ($34.value0.type === "grass") {
                                                                                  return v;
                                                                              };
                                                                              if ($34.value0.type === "cray") {
                                                                                  return v1;
                                                                              };
                                                                              return v;
                                                                          })();
                                                                          return function __do() {
                                                                              Graphics_Canvas.drawImageScale(v9)(img)(Data_Int.toNumber(x))(Data_Int.toNumber(y))(1.0)(1.0)();
                                                                              return Data_Unit.unit;
                                                                          };
                                                                      })());
                                                                  };
                                                                  throw new Error("Failed pattern match at Game.Zombie.Render line 67, column 29 - line 76, column 46: " + [ $34.constructor.name ]);
                                                              });
                                                          })();
                                                          return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_StrMap.foldableStrMap)(v10.value0.objects)(function (p) {
                                                              return Graphics_Toyger_Matrix.applyv(Graphics_Canvas.drawImageScale(v9)(v2))(Graphics_Toyger_Matrix.subv(p.position)(Graphics_Toyger_Matrix.vector(0.5)(0.5)))(1.0)(1.0);
                                                          })();
                                                      })();
                                                      ...
                                                      })(Data_StrMap.toList(v10.value0.objects));
                                                      ...
                                                      return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_List.foldableList)(sorted)(function (v11) {
                                                          return Graphics_Canvas.withContext(v9)((function () {
                                                              if (v11.value1.value1.type === "zombie") {
                                                                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                                      ...
                                                                      return Graphics_Canvas.drawImage(v9)(v5)(-25.0)(-64.0)();
                                                                  });
                                                              };
                                                              if (v11.value1.value1.type === "player") {
                                                                  if (v11.value1.value0 === v10.value0.userID) {
                                                                      return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                                          Graphics_Canvas.translate(Graphics_Toyger_Matrix.applyv(function (v12) {
                                                                              return function (v13) {
                                                                                  return {
                                                                          ...
                                                                          })(Graphics_Toyger_Matrix.mulv(m)(v10.value0.player.position)))(v9)();
                                                                          return Graphics_Canvas.drawImage(v9)(v3)(-18.0)(-64.0)();
                                                                      });
                                                                  };
                                                                  if (Data_Boolean.otherwise) {
                                                                      return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                                          ...
                                                                          return Graphics_Canvas.drawImage(v9)(v4)(-15.0)(-64.0)();
                                                                      });
                                                                  };
                                                              };
                                                              if (v11.value1.value1.type === "tree") {
                                                                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                                      ...
                                                                      return Graphics_Canvas.drawImage(v9)(v6)(-25.0)(-80.0)();
                                                                  });
                                                              };
                                                              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Data_Unit.unit);
                                                          })());
                                              ...
                                              throw new Error("Failed pattern match at Game.Zombie.Render line 36, column 5 - line 103, column 31: " + [ v10.constructor.name ]);
                                          });
                                      });
                                  });
                              });
          ...
          return function __do() {
              ...
              if (v instanceof Game_Zombie_Types.Playing) {
                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                      ...
                      var v3 = Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Ring.sub(Data_Ring.ringNumber))(zeroOrOne(39)))(zeroOrOne(37))();
                      var v4 = Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Ring.sub(Data_Ring.ringNumber))(zeroOrOne(40)))(zeroOrOne(38))();
                      var rotation = v.value0.rotation + v2 * 2.0e-2;
                      var move = Graphics_Toyger_Matrix.mulv(Graphics_Toyger_Matrix.rotationMatrix(-rotation))(Graphics_Toyger_Matrix.scalev(4.0e-2)(Graphics_Toyger_Matrix.normalize(Graphics_Toyger_Matrix.vector(v3)(v4))));
                      var state = (function () {
                          var $29 = {};
                          ...
                          $29.player = (function () {
                              var $26 = {};
                              for (var $27 in v.value0.player) {
                                  if (v.value0.player.hasOwnProperty($27)) {
                                      $26[$27] = v.value0.player[$27];
                                  };
                              };
                              $26.position = Graphics_Toyger_Matrix.addv(v.value0.player.position)(move);
                              return $26;
                          })();
                          return $29;
                      })();
                      var v5 = Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(Data_StrMap.toList(state.objects))(function (v5) {
                          if (v5.value1.type === "zombie") {
                              var delta = Graphics_Toyger_Matrix.subv(state.player.position)(v5.value1.position);
                              var $34 = 0.5 < Graphics_Toyger_Matrix.absv(delta) && Graphics_Toyger_Matrix.absv(delta) < 3.0;
                              if ($34) {
                                  var p = Graphics_Toyger_Matrix.addv(v5.value1.position)(Graphics_Toyger_Matrix.scalev(4.0e-3)(Graphics_Toyger_Matrix.normalize(delta)));
                                  return function __do() {
                                      Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase.database(firebase))(Web_Firebase.ref("/objects")))(Web_Firebase.child(v5.value0)))(Web_Firebase.child("position")))(Web_Firebase.set(Data_Foreign.toForeign(p)))();
                                      return new Data_Tuple.Tuple(v5.value0, (function () {
                                          var $35 = {};
                                          for (var $36 in v5.value1) {
                                              if (v5.value1.hasOwnProperty($36)) {
                                                  $35[$36] = v5.value1[$36];
                                              };
                                          };
                                          $35.position = p;
                              ...
                              if (!$34) {
                                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(new Data_Tuple.Tuple(v5.value0, v5.value1));
                              };
                              throw new Error("Failed pattern match at Game.Zombie.Main line 72, column 29 - line 77, column 58: " + [ $34.constructor.name ]);
                          };
                          return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(new Data_Tuple.Tuple(v5.value0, v5.value1));
                      })();
                      Data_Function.apply(write)(new Game_Zombie_Types.Playing((function () {
                          var $41 = {};
                          for (var $42 in state) {
                              if (state.hasOwnProperty($42)) {
                                  $41[$42] = state[$42];
                              };
                          };
                          $41.objects = Data_StrMap.fromFoldable(Data_List.foldableList)(v5);
                          return $41;
                      })()))();
                      return Data_Function.apply(Control_Applicative.when(Control_Monad_Eff.applicativeEff)(v3 !== 0.0 || v4 !== 0.0))(Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase.database(firebase))(Web_Firebase.ref("/objects")))(Web_Firebase.child(state.userID)))(Web_Firebase.set(Data_Foreign.toForeign(state.player)))))();
                  })();
              };
              throw new Error("Failed pattern match at Game.Zombie.Main line 34, column 5 - line 88, column 117: " + [ v.constructor.name ]);
          };
      };
  };
      ...
      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
          ...
          Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase.auth(v1))(Web_Firebase.onAuthStateChanged(function (scene) {
              return function __do() {
                                  ...
                                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                                      ...
                                      return function __do() {
                                          Data_Function.apply(write)(new Game_Zombie_Types.Playing({
                                              ...
                                              player: Data_Function.apply(Data_Maybe.fromMaybe({
                                                  type: "player", 
                                                  position: Graphics_Toyger_Matrix.zeroVector
                                              }))(Data_StrMap.lookup(Web_Firebase.uid(scene.value0))(objects)), 
                                          ...
                                          var onValueTo = function (path) {
                                              return function (f) {
                                                  return Data_Function.applyFlipped(path)(Web_Firebase.onValue(function (snap) {
                                                      return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                          var v8 = read();
                                                          if (v8 instanceof Game_Zombie_Types.Playing) {
                                                              return Data_Function.apply(Data_Functor["void"](Control_Monad_Eff.functorEff))(Data_Function.apply(write)(Data_Function.apply(Game_Zombie_Types.Playing.create)(f(Web_Firebase.val(snap))(v8.value0))))();
                                                          };
                                                          return Data_Unit.unit;
                                                      });
                                                  }));
                                          ...
                                          onValueTo(v3)(function (v8) {
                                              return function (v9) {
                                                  var $56 = {};
                                                  for (var $57 in v9) {
                                                      if (v9.hasOwnProperty($57)) {
                                                          $56[$57] = v9[$57];
                                                      };
                                                  };
                                                  $56.geometry = Data_Foreign.unsafeFromForeign(v8);
                                                  return $56;
                                              };
                                          })();
                                          return onValueTo(v4)(function (v8) {
                                              return function (v9) {
                                                  var $59 = {};
                                                  for (var $60 in v9) {
                                                      if (v9.hasOwnProperty($60)) {
                                                          $59[$60] = v9[$60];
                                                      };
                                                  };
                                                  $59.objects = Data_Foreign.unsafeFromForeign(v8);
                                                  return $59;
                                              };
                                          })();
                                      };
                  ...
                  throw new Error("Failed pattern match at Game.Zombie.Main line 108, column 13 - line 141, column 93: " + [ scene.constructor.name ]);
              };
          }))();
          return Graphics_Toyger.gameloop(function __do() {
              update(v1)(v2)();
              return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_Eff_Ref.readRef(v2))(v)();
          })();
      });
  })));
...
},{"firebase":5}],2:[function(require,module,exports){
(function (global){

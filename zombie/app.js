                                              ...
                                              return function (count) {
                                                  ...
                                                  if (scene instanceof Game_Zombie_Types.Playing) {
                                                      return Data_Function.apply(Graphics_Canvas.withContext(v9))(Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                          ...
                                                          })(Data_StrMap.toList(scene.value0.objects));
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Zombie.Render line 36, column 26 - line 111, column 31: " + [ scene.constructor.name ]);
                                              };
                                          });
                                      });
                                  });
      ...
      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
          ...
          Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase.auth(v1))(Web_Firebase.onAuthStateChanged(function (scene) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at Game.Zombie.Main line 111, column 13 - line 145, column 93: " + [ scene.constructor.name ]);
              };
          }))();

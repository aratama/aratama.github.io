                                              ...
                                              return function (count) {
                                                  ...
                                                  if (scene instanceof Game_Zombie_Types.Loading) {
                                                      return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                          ...
                                                          Graphics_Canvas.setFont("20px serif")(v9)();
                                                          Graphics_Canvas.setFillStyle("white")(v9)();
                                                          Graphics_Canvas.fillText(v9)("Now loading...")(30.0)(30.0)();
                                                          return Graphics_Canvas.withContext(v9)(function __do() {
                                                              Graphics_Canvas.translate({
                                                                  translateX: 100.0, 
                                                                  translateY: 100.0
                                                              })(v9)();
                                                              Graphics_Canvas.rotate(Data_Int.toNumber(count) * 1.0e-2)(v9)();
                                                              return Graphics_Canvas.drawImage(v9)(v5)(-20.0)(-20.0)();
                                                          })();
                                                      });
                                                  };
                                                  if (scene instanceof Game_Zombie_Types.Playing) {
                                                      return Data_Function.apply(Graphics_Canvas.withContext(v9))(Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                          ...
                                                          Graphics_Canvas.withContext(v9)(function __do() {
                                                              ...
                                                              Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_List.foldableList)(Data_List.range(0)(Game_Zombie_Constants.chunkSize - 1))(function (y) {
                                                                  return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_List.foldableList)(Data_List.range(0)(Game_Zombie_Constants.chunkSize - 1))(function (x) {
                                                                      var $33 = Data_StrMap.lookup(Data_Show.show(Data_Show.showInt)((Game_Zombie_Constants.chunkSize * y | 0) + x | 0))(scene.value0.geometry);
                                                                      ...
                                                                      if ($33 instanceof Data_Maybe.Just) {
                                                                          return Data_Functor["void"](Control_Monad_Eff.functorEff)((function () {
                                                                              var img = (function () {
                                                                                  if ($33.value0.type === "grass") {
                                                                                      return v;
                                                                                  };
                                                                                  if ($33.value0.type === "cray") {
                                                                                      return v1;
                                                                                  };
                                                                                  return v;
                                                                              })();
                                                                      ...
                                                                      throw new Error("Failed pattern match at Game.Zombie.Render line 75, column 29 - line 84, column 46: " + [ $33.constructor.name ]);
                                                                  });
                                                              })();
                                                              return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_StrMap.foldableStrMap)(scene.value0.objects)(function (p) {
                                                          ...
                                                          var targetObjects = Data_StrMap.insert(scene.value0.userID)(scene.value0.player)(scene.value0.objects);
                                                          var withPosition = Data_Functor.map(Data_List.functorList)(function (v10) {
                                                              return new Data_Tuple.Tuple(Graphics_Toyger_Matrix.mulv(m)(v10.value1.position), new Data_Tuple.Tuple(v10.value0, v10.value1));
                                                          })(Data_StrMap.toList(targetObjects));
                                                          var sorted = Data_List.sortBy(function (v10) {
                                                              return function (v11) {
                                                                  return Data_Ord.compare(Data_Ord.ordNumber)((Graphics_Toyger_Matrix.runVector(v10.value0)).y)((Graphics_Toyger_Matrix.runVector(v11.value0)).y);
                                                              };
                                                          })(withPosition);
                                                          return Data_Foldable.for_(Control_Monad_Eff.applicativeEff)(Data_List.foldableList)(sorted)(function (v10) {
                                                              return Graphics_Canvas.withContext(v9)((function () {
                                                                  if (v10.value1.value1.type === "zombie") {
                                                                      return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                                          Graphics_Canvas.translate(Graphics_Toyger_Matrix.applyv(function (v11) {
                                                                              return function (v12) {
                                                                                  return {
                                                                                      translateX: v11, 
                                                                                      translateY: v12
                                                                  ...
                                                                  if (v10.value1.value1.type === "player") {
                                                                      if (v10.value1.value0 === scene.value0.userID) {
                                                                          return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                                              Graphics_Canvas.translate(Graphics_Toyger_Matrix.applyv(function (v11) {
                                                                                  return function (v12) {
                                                                                      return {
                                                                              ...
                                                                              })(Graphics_Toyger_Matrix.mulv(m)(scene.value0.player.position)))(v9)();
                                                                  ...
                                                                  if (v10.value1.value1.type === "tree") {
                                                                      return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                                                                          Graphics_Canvas.translate(Graphics_Toyger_Matrix.applyv(function (v11) {
                                                                              return function (v12) {
                                                                                  return {
                                                  ...
                                                  throw new Error("Failed pattern match at Game.Zombie.Render line 36, column 26 - line 112, column 31: " + [ scene.constructor.name ]);
                                              };
                                          });
                                      });
                                  });
  ...
  var update = function (firebase) {
      return function (stateRef) {
          ...
          return function __do() {
              ...
              if (v instanceof Game_Zombie_Types.Playing) {
                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
                      ...
                      var state = (function () {
                          ...
                          $33.pitch = Data_Function.apply($$Math.max(0.3))(Data_Function.apply($$Math.min(0.9))(v.value0.pitch - v3 * 1.0e-2));
                          $33.player = (function () {
                              var $30 = {};
                              for (var $31 in v.value0.player) {
                                  if (v.value0.player.hasOwnProperty($31)) {
                                      $30[$31] = v.value0.player[$31];
                                  };
                              };
                              $30.position = Graphics_Toyger_Matrix.addv(v.value0.player.position)(move);
                              return $30;
                          })();
                          return $33;
                      })();
                      var v6 = Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(Data_StrMap.toList(state.objects))(function (v6) {
                          if (v6.value1.type === "zombie") {
                              ...
                              var $38 = 0.5 < Graphics_Toyger_Matrix.absv(delta) && Graphics_Toyger_Matrix.absv(delta) < 3.0;
                              if ($38) {
                                  ...
                                  return function __do() {
                                      ...
                                      return new Data_Tuple.Tuple(v6.value0, (function () {
                                          var $39 = {};
                                          for (var $40 in v6.value1) {
                                              if (v6.value1.hasOwnProperty($40)) {
                                                  $39[$40] = v6.value1[$40];
                                              };
                                          };
                                          $39.position = p;
                              ...
                              throw new Error("Failed pattern match at Game.Zombie.Main line 75, column 29 - line 80, column 58: " + [ $38.constructor.name ]);
                          };
                          return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(new Data_Tuple.Tuple(v6.value0, v6.value1));
                      })();
                      Data_Function.apply(write)(new Game_Zombie_Types.Playing((function () {
                          var $45 = {};
                          for (var $46 in state) {
                              if (state.hasOwnProperty($46)) {
                                  $45[$46] = state[$46];
                              };
                          };
                          $45.objects = Data_StrMap.fromFoldable(Data_List.foldableList)(v6);
                          return $45;
                      })()))();
              ...
              throw new Error("Failed pattern match at Game.Zombie.Main line 35, column 5 - line 91, column 117: " + [ v.constructor.name ]);
          };
      };
  };
      ...
      return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(function __do() {
          ...
          Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase.auth(v1))(Web_Firebase.onAuthStateChanged(function (scene) {
              return function __do() {
                          ...
                          return Control_Monad_Aff.runAff(Control_Monad_Eff_Console.logShow(Control_Monad_Eff_Exception.showError))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Control_Bind.bind(Control_Monad_Aff.bindAff)(Web_Firebase_Aff.onceAff(v3))(function (v6) {
                              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Web_Firebase_Aff.onceAff(v4))(function (v7) {
                                  return Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)((function () {
                                      ...
                                      var player = Data_Function.apply(Data_Maybe.fromMaybe({
                                          type: "player", 
                                      ...
                                      return function __do() {
                                          ...
                                          Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase.onDisconnect(v5))(Web_Firebase.set(Data_Foreign.toForeign({
                                              type: "player", 
                                          ...
                                          onValueTo(v3)(function (v8) {
                                              return function (v9) {
                                                  var $60 = {};
                                                  for (var $61 in v9) {
                                                      if (v9.hasOwnProperty($61)) {
                                                          $60[$61] = v9[$61];
                                                      };
                                                  };
                                                  $60.geometry = Data_Foreign.unsafeFromForeign(v8);
                                                  return $60;
                                              };
                                          })();
                                          onValueTo(v4)(function (v8) {
                                              return function (v9) {
                                                  var $63 = {};
                                                  for (var $64 in v9) {
                                                      if (v9.hasOwnProperty($64)) {
                                                          $63[$64] = v9[$64];
                                                      };
                                                  };
                                                  $63.objects = Data_Foreign.unsafeFromForeign(v8);
                                                  return $63;
                                              };
                                          })();
                                          return Data_Unit.unit;
                  ...
                  throw new Error("Failed pattern match at Game.Zombie.Main line 111, column 13 - line 149, column 38: " + [ scene.constructor.name ]);
              };
          }))();

                  ...
                  return function __do() {
                      ...
                      return new Data_Tuple.Tuple(Data_Show.show(Data_Show.showInt)(x) + ("," + Data_Show.show(Data_Show.showInt)(y)), {
                          type: (function () {
                              ...
                              throw new Error("Failed pattern match at Game.Zombie.Console line 57, column 25 - line 58, column 13: " + [ $16.constructor.name ]);
                          })()
                      });
                  };
              });
          }))();
          var v1 = Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List_Types.traversableList)(Data_List.range(0)(5))(function (i) {
              return function __do() {
                  var v1 = Control_Monad_Eff_Random.randomRange(0.0)(Data_Int.toNumber(Game_Zombie_Constants.chunkSize))();
                  var v2 = Control_Monad_Eff_Random.randomRange(0.0)(Data_Int.toNumber(Game_Zombie_Constants.chunkSize))();
                  var v3 = Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List_Types.traversableList)(Data_List.range(0)(10))(function (v3) {
                      return Control_Monad_Eff_Random.randomInt(0)(9);
                  })();
                  return new Data_Tuple.Tuple(Data_Foldable.foldMap(Data_List_Types.foldableList)(Data_Monoid.monoidString)(Data_Show.show(Data_Show.showInt))(v3), {
                      type: "zombie", 
                      position: Graphics_Toyger_Matrix.vector2(v1)(v2), 
                      status: "active"
                  });
              };
          })();
          return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase.database(firebase))(Web_Firebase.ref("/chunks/chunk(0,0)")))(Web_Firebase.set(Data_Foreign.toForeign({
              geometry: Data_StrMap.fromFoldable(Data_List_Types.foldableList)(v), 
              objects: Data_StrMap.fromFoldable(Data_List_Types.foldableList)(v1)
          })))();
      });
  };
      ...
      return Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase.auth(v))(Web_Firebase.onAuthStateChanged(function (v1) {
          ...
          if (v1 instanceof Data_Maybe.Just) {
              return function __do() {
                  ...
                  throw new Error("Failed pattern match at Game.Zombie.Console line 33, column 13 - line 38, column 124: " + [ v2.constructor.name ]);
              };
          };
          throw new Error("Failed pattern match at Game.Zombie.Console line 29, column 5 - line 38, column 124: " + [ v1.constructor.name ]);
      }))();
  });
      ...
      return function (password) {
          return Data_Functor["void"](Control_Monad_Eff.functorEff)(function __do() {
              ...
              return Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase.auth(v))(Web_Firebase.onAuthStateChanged(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Game.Zombie.Console line 83, column 5 - line 92, column 79: " + [ v1.constructor.name ]);
              }))();
          });
      };
  };

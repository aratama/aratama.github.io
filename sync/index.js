...
(function(exports) {
  ...
  var Synchronicity_Server = PS["Synchronicity.Server"];
...
})(PS["Synchronicity.Type"] = PS["Synchronicity.Type"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
      ...
      return function (firebase) {
          return function (f) {
              ...
              var addListener = function (resolve) {
                  return Data_Functor["void"](Control_Monad_Eff.functorEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase4_App_App.database(firebase))(Web_Firebase4_Database_Database.ref("timers/example")))(Web_Firebase4_Database_Reference.on(Web_Firebase4_Type.Value.value)(Control_Monad_Eff_Console.logShow(Control_Monad_Eff_Exception.showError))(function (snapshot) {
                      return resolve(Data_Foreign.unsafeFromForeign(Web_Firebase4_Database_Snapshot.val(snapshot)));
                  })));
              };
  ...
  var setValue = function (value) {
      return function (firebase) {
          return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Web_Firebase4_App_App.database(firebase))(Web_Firebase4_Database_Database.ref("timers/example")))(Web_Firebase4_Database_Reference.set(Data_Foreign.toForeign(value)));
      };
  };
  exports["setValue"] = setValue;
  exports["subscribeValue"] = subscribeValue;
})(PS["Synchronicity.Client"] = PS["Synchronicity.Client"] || {});
(function(exports) {
    "use strict";
  ...
  exports["up"] = up;
})(PS["Synchronicity.Classes"] = PS["Synchronicity.Classes"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Alt = PS["Control.Alt"];
...
(function(exports) {
  ...
  var Halogen_HTML_Properties = PS["Halogen.HTML.Properties"];
  var Prelude = PS["Prelude"];
  var Synchronicity_Classes = PS["Synchronicity.Classes"];
  var Synchronicity_Type = PS["Synchronicity.Type"];
  ...
  var render = function (state) {
      ...
      var renderHelp = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Synchronicity_Classes.help, (function () {
          if (state.help) {
              return Synchronicity_Classes.empty;
          };
          return Synchronicity_Classes.hidden;
      })() ]) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Synchronicity_Classes.dialog) ])([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Synchronicity") ]), Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("\u9060\u9694\u64cd\u4f5c\u53ef\u80fd\u30b9\u30d4\u30fc\u30c1\u30bf\u30a4\u30de\u30fc") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("\u4ed6\u306e\u30c7\u30d0\u30a4\u30b9\u3068\u30bf\u30a4\u30de\u30fc\u3092\u5171\u6709\u3059\u308b\u306b\u306f\u3001") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("\u53cc\u65b9\u306b\u540c\u3058\u30bf\u30a4\u30de\u30fcID\u3092\u5165\u529b\u3057\u3066\u304f\u3060\u3055\u3044\u3002") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Synchronicity_Classes.timerIDClass) ])([ Halogen_HTML_Elements.span([  ])([ Halogen_HTML_Core.text("\u30bf\u30a4\u30de\u30fcID") ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.value(state.timerID) ]) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.class_(Synchronicity_Classes.close), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Synchronicity_Type.CloseHelp.create)) ])([ Halogen_HTML_Core.text("\u65e2\u5b58\u306e\u30bf\u30a4\u30de\u30fc\u306b\u63a5\u7d9a\u3059\u308b") ]) ]) ]);
      ...
      var digit = function (n) {
          return function (shift) {
              var buttonDisabled = (function () {
                  var $1 = !state.active && state.count === state.max;
                  if ($1) {
                      return Synchronicity_Classes.empty;
                  };
                  return Synchronicity_Classes.disabled;
              })();
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Synchronicity_Classes.digit) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Synchronicity_Classes.triangle, Synchronicity_Classes.up, buttonDisabled ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Synchronicity_Type.Adjust.create(shift))) ])([ Halogen_HTML_Core.text("\u25b2") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("number") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(n)) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Synchronicity_Classes.triangle, Synchronicity_Classes.down, buttonDisabled ]), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Synchronicity_Type.Adjust.create(-shift | 0))) ])([ Halogen_HTML_Core.text("\u25bc") ]) ]);
          };
      };
      ...
      var d2 = seconds / 10 | 0;
      var d3 = seconds % 10;
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Synchronicity_Classes.root) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ Synchronicity_Classes.display, (function () {
          var $2 = 0 <= state.count;
          if ($2) {
              return Synchronicity_Classes.empty;
          };
          return Synchronicity_Classes.over;
      })() ]) ])([ digit(d0)(600), digit(d1)(60), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Synchronicity_Classes.colon) ])([ Halogen_HTML_Core.text(":") ]), digit(d2)(10), digit(d3)(1) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Synchronicity_Classes.controls) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Synchronicity_Type.Backward.create)), Halogen_HTML_Properties.class_((function () {
          var $3 = state.active || state.count === state.max;
          if ($3) {
              return Synchronicity_Classes.disabled;
          };
          return Synchronicity_Classes.empty;
      })()) ])([ icon("fast-backward") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Synchronicity_Type.Play.create)), Halogen_HTML_Properties.class_((function () {
          if (state.active) {
              return Synchronicity_Classes.disabled;
          };
          return Synchronicity_Classes.empty;
      })()) ])([ icon("play") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Synchronicity_Type.Pause.create)), Halogen_HTML_Properties.class_((function () {
          if (state.active) {
              return Synchronicity_Classes.empty;
          };
          return Synchronicity_Classes.disabled;
      })()) ])([ icon("pause") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Synchronicity_Type.Help.create)) ])([ icon("question") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Synchronicity_Classes.progress) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(Synchronicity_Classes.bar), style("width: " + (Text_Format.format(Text_Format.formatNumber)(Text_Format.precision(2))((100.0 * Data_Int.toNumber(Data_Ord.max(Data_Ord.ordInt)(0)(state.count))) / Data_Int.toNumber(state.max)) + "%")) ])([  ]) ]), renderHelp ]);
  };
  exports["render"] = render;
})(PS["Synchronicity.Render"] = PS["Synchronicity.Render"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var Halogen_Query_HalogenM = PS["Halogen.Query.HalogenM"];
  var Prelude = PS["Prelude"];
  var Synchronicity_Client = PS["Synchronicity.Client"];
  var Synchronicity_Render = PS["Synchronicity.Render"];
  var Synchronicity_Server = PS["Synchronicity.Server"];
  var Synchronicity_Type = PS["Synchronicity.Type"];
      ...
      var updateServerValue = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))((function () {
              ...
              if (v.firebase instanceof Data_Maybe.Just) {
                  return Synchronicity_Client.setValue({
                      max: v.max, 
                      count: v.count, 
                      active: v.active
                  })(v.firebase.value0);
              };
              throw new Error("Failed pattern match at Synchronicity.UI line 128, column 17 - line 134, column 23: " + [ v.firebase.constructor.name ]);
          })());
      });
      return function (v) {
          if (v instanceof Synchronicity_Type.Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Web_Firebase4.initializeApp({
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                          ...
                          $30.firebase = new Data_Maybe.Just(v2);
                          return $30;
                      })()))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Synchronicity_Client.subscribeValue(Control_Monad_Aff_Class.monadAffAff)(v2)(Synchronicity_Type.Update.create))(function () {
          ...
          if (v instanceof Synchronicity_Type.Update) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      var $35 = {};
                      for (var $36 in v1) {
                      ...
                      $35.count = v.value0.count;
                      $35.max = v.value0.max;
                      $35.active = v.value0.active;
                      return $35;
                  })()))(function () {
          ...
          if (v instanceof Synchronicity_Type.Menu) {
              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
          };
          if (v instanceof Synchronicity_Type.Backward) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      var $42 = {};
                      for (var $43 in v1) {
                      ...
                      $42.count = Data_Ord.max(Data_Ord.ordInt)(-5999 | 0)(Data_Ord.min(Data_Ord.ordInt)(5999)(v1.max));
                      $42.active = false;
                      return $42;
                  })()))(function () {
          ...
          if (v instanceof Synchronicity_Type.Play) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  var value = (function () {
                      var $47 = {};
                      for (var $48 in v1) {
          ...
          if (v instanceof Synchronicity_Type.Pause) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      var $52 = {};
                      for (var $53 in v1) {
          ...
          if (v instanceof Synchronicity_Type.Help) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      var $57 = {};
                      for (var $58 in v1) {
          ...
          if (v instanceof Synchronicity_Type.Tick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(v1.active)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      ...
                      $62.count = Data_Ord.max(Data_Ord.ordInt)(-5999 | 0)(Data_Ord.min(Data_Ord.ordInt)(5999)(v1.count - 1 | 0));
                      return $62;
                  })())))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
          ...
          if (v instanceof Synchronicity_Type.Adjust) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at Synchronicity.UI line 98, column 9 - line 113, column 43: " + [ v1.active.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          };
          if (v instanceof Synchronicity_Type.CloseHelp) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      var $77 = {};
                      for (var $78 in v1) {
          ...
          throw new Error("Failed pattern match at Synchronicity.UI line 24, column 8 - line 121, column 18: " + [ v.constructor.name ]);
      };
  })();
  var ui = Halogen_Component.component(Halogen_HTML_Core.bifunctorHTML)({
      render: Synchronicity_Render.render, 
      "eval": $$eval, 
  ...
  exports["ui"] = ui;
})(PS["Synchronicity.UI"] = PS["Synchronicity.UI"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
  ...
  var Prelude = PS["Prelude"];
  var Synchronicity_Type = PS["Synchronicity.Type"];
  var Synchronicity_UI = PS["Synchronicity.UI"];        
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(Synchronicity_UI.ui)("cats")(v))(function (v1) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(v1.query(Halogen_Query.action(Synchronicity_Type.Initialize.create)))(function () {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Timer.setInterval(1000)(Halogen_Aff_Util.runHalogenAff(v1.query(Halogen_Query.action(Synchronicity_Type.Tick.create))))))(function (v2) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
              });
          });
      });
  ...
  exports["main"] = main;
})(PS["Synchronicity.Main"] = PS["Synchronicity.Main"] || {});
(function(exports) {
  // Generated by purs version 0.11.6
  "use strict";
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Data_Unit = PS["Data.Unit"];
  var Synchronicity_Main = PS["Synchronicity.Main"];
  var Synchronicity_Type = PS["Synchronicity.Type"];        
  var main = Synchronicity_Main.main;
  exports["main"] = main;
})(PS["Main"] = PS["Main"] || {});
PS["Main"].main();
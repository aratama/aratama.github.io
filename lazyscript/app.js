...
(function(exports) {exports.invokeForeignFunction = function(callee){
  ...
  exports.foreignToBoolean = function(x){
      return x ? true : false;
  }
...
(function(exports) {
  ...
  var Data_Foreign = PS["Data.Foreign"];
  exports["foreignToBoolean"] = $foreign.foreignToBoolean;
  exports["invokeForeignFunction"] = $foreign.invokeForeignFunction;
  exports["now"] = $foreign.now;
  exports["operate"] = $foreign.operate;
})(PS["LazyScript.Foreign"] = PS["LazyScript.Foreign"] || {});
(function(exports) {
  // Generated by psc version 0.9.3
  "use strict";
  ...
  var generic_Expression = new Data_Generic.Generic(function (v) {
      ...
      if (v instanceof Data_Generic.SProd && (v.value0 === "LazyScript.Types.Lambda" && v.value1.length === 3)) {
          return Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(Control_Apply.apply(Data_Maybe.applyMaybe)(new Data_Maybe.Just(Lambda.create))(Data_Generic.fromSpine(Data_List.genericList(Data_Generic.genericString))(v.value1[0](Data_Unit.unit))))(Data_Generic.fromSpine(Data_List.genericList(Data_Generic.genericTuple(Data_Generic.genericString)(generic_Expression)))(v.value1[1](Data_Unit.unit))))(Data_Generic.fromSpine(generic_Expression)(v.value1[2](Data_Unit.unit)));
      };
      ...
      if (v instanceof Lambda) {
          return new Data_Generic.SProd("LazyScript.Types.Lambda", [ function ($dollarq) {
              ...
              return Data_Generic.toSpine(Data_List.genericList(Data_Generic.genericTuple(Data_Generic.genericString)(generic_Expression)))(v.value1);
          }, function ($dollarq) {
              return Data_Generic.toSpine(generic_Expression)(v.value2);
          } ]);
      };
  ...
  var generic_Statement = new Data_Generic.Generic(function (v) {
      ...
      throw new Error("Failed pattern match at LazyScript.Types line 36, column 1 - line 36, column 55: " + [ v.constructor.name ]);
  });
  ...
  var expressions = function (v) {
      return Data_List.catMaybes(Data_Functor.map(Data_List.functorList)(function (statement) {
          ...
          throw new Error("Failed pattern match at LazyScript.Types line 51, column 66 - line 53, column 45: " + [ statement.constructor.name ]);
      })(v.value0));
  };                                                                       
  var assignments = function (v) {
      return Data_Function.apply(Data_List.catMaybes)(Data_Functor.map(Data_List.functorList)(function (statement) {
          if (statement instanceof Assignment) {
          ...
          throw new Error("Failed pattern match at LazyScript.Types line 45, column 67 - line 47, column 28: " + [ statement.constructor.name ]);
      })(v.value0));
  };
  ...
  var program = (function () {
      var lexer = (function () {
          ...
          return Data_Function.apply(Text_Parsing_Parser_Token.makeTokenParser(Data_Identity.monadIdentity))({
              ...
              opStart: op, 
              opLetter: op, 
              reservedNames: [ "true", "false", "null", "undefined", "return" ], 
              reservedOpNames: [ "?", ":", "=", "++" ], 
              caseSensitive: true
          });
      })();
      var expression$prime = function (expression) {
          var post = function (cond) {
              var dot = function (cond1) {
                  return Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(LazyScript_Types.Dot.create(cond1))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(lexer.dot)(lexer.identifier)))("dot binary");
              };
              var call = function (cond1) {
                  return Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(LazyScript_Types.Call.create(cond1))(lexer.parens(Text_Parsing_Parser_Combinators.sepBy(Data_Identity.monadIdentity)(expression)(lexer.comma))))("call binary");
              };
              return Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(call(cond))(dot(cond)))(post))(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(cond));
          };
          var conditional = function (cond) {
              return Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(LazyScript_Types.Conditional.create(cond))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(lexer.symbol("?"))(expression)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(lexer.colon)(expression));
          };
          var binaries = (function () {
              ...
              var parens = lexer.parens(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(expression)(function (v) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Data_Function.apply(Data_List.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(lexer.comma)(expression)))(function (v1) {
                      return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity)))(Data_Foldable.foldl(Data_List.foldableList)(function (x) {
                          return function (s) {
                              return new LazyScript_Types.Seq(x, s);
                          };
                      })(v)(v1));
                  });
              }));
              var objectLiteral = (function () {
                  var pair = Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Tuple.Tuple.create)(lexer.identifier))(lexer.colon))(expression))("key-value pair");
                  return Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))((LazyScript_Types["Object"]).create)(Data_Function.apply(lexer.braces)(Text_Parsing_Parser_Combinators.sepBy(Data_Identity.monadIdentity)(pair)(lexer.comma))))("object");
              })();
              var numberLiteral = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Text_Parsing_Parser_String["char"](Data_Identity.monadIdentity)("-"))(new Data_Tuple.Tuple(Data_Ring.negate(Data_Ring.ringInt), Data_Ring.negate(Data_Ring.ringNumber))))(Data_Functor.voidLeft(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Text_Parsing_Parser_String["char"](Data_Identity.monadIdentity)("+"))(new Data_Tuple.Tuple(Control_Category.id(Control_Category.categoryFn), Control_Category.id(Control_Category.categoryFn)))))(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(new Data_Tuple.Tuple(Control_Category.id(Control_Category.categoryFn), Control_Category.id(Control_Category.categoryFn)))))("sign"))(function (v) {
                  return Text_Parsing_Parser_Combinators.withErrorMessage(Data_Identity.monadIdentity)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Either.either(function ($16) {
                      return LazyScript_Types.Int.create(v.value0($16));
                  })(function ($17) {
                      return (LazyScript_Types["Number"]).create(v.value1($17));
              ...
              var lambda = (function () {
                  var block = function (args) {
                      return lexer.braces(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Data_Function.apply(Data_List.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Tuple.Tuple.create)(lexer.identifier))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(lexer.symbol("="))(expression)))(Text_Parsing_Parser_Combinators.optional(Data_Identity.monadIdentity)(lexer.semi))))(function (v) {
                          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(lexer.reserved("return"))(expression))(Text_Parsing_Parser_Combinators.optional(Data_Identity.monadIdentity)(lexer.semi)))(function (v1) {
                              return Data_Function.apply(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity)))(new LazyScript_Types.Lambda(args, v, v1));
                          });
                      }));
                  };
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(lexer.parens(Text_Parsing_Parser_Combinators.sepBy(Data_Identity.monadIdentity)(lexer.identifier)(lexer.comma)))(function (v) {
                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(lexer.symbol("=>"))(function () {
                          return Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(block(v))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(LazyScript_Types.Lambda.create(v)(Data_List.Nil.value))(expression));
                      });
                  });
              })();
      ...
      var expression$prime$prime = Control_Lazy.fix(Text_Parsing_Parser.lazyParserT)(function (f) {
          return expression$prime(f);
      });
      var statement = (function () {
          var expressionStatement = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(LazyScript_Types.Expression.create)(expression$prime$prime);
          var assignmentStatement = Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(LazyScript_Types.Assignment.create)(lexer.identifier))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(lexer.symbol("="))(expression$prime$prime));
          return Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.functorIdentity)(assignmentStatement))(expressionStatement))(Text_Parsing_Parser_Combinators.optional(Data_Identity.monadIdentity)(lexer.semi));
      })();
...
(function(exports) {
  ...
  var Primitive = (function () {
      function Primitive(value0) {
          this.value0 = value0;
      };
      Primitive.create = function (value0) {
          return new Primitive(value0);
      };
      return Primitive;
  })();
  var LambdaRef = (function () {
      function LambdaRef(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      LambdaRef.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new LambdaRef(value0, value1, value2);
              };
          };
      };
      return LambdaRef;
  ...
  var NativeFunction = (function () {
      function NativeFunction(value0) {
          this.value0 = value0;
      };
      NativeFunction.create = function (value0) {
          return new NativeFunction(value0);
      };
  ...
  var ObjectRef = (function () {
      function ObjectRef(value0) {
          this.value0 = value0;
      };
      ObjectRef.create = function (value0) {
          return new ObjectRef(value0);
      };
      return ObjectRef;
  })();
  ...
  var ConditionalRef = (function () {
      function ConditionalRef(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      ConditionalRef.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new ConditionalRef(value0, value1, value2);
              };
          };
      };
  ...
  var DotRef = (function () {
      function DotRef(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      DotRef.create = function (value0) {
          return function (value1) {
              return new DotRef(value0, value1);
          };
      };
      return DotRef;
  })();
  var SeqRef = (function () {
      function SeqRef(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      SeqRef.create = function (value0) {
          return function (value1) {
              return new SeqRef(value0, value1);
          };
      };
      return SeqRef;
  })();
  ...
  var Scope = (function () {
      function Scope(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      Scope.create = function (value0) {
          return function (value1) {
              return new Scope(value0, value1);
          };
      };
      return Scope;
  })();
  var replace = function (strmap) {
      return function (value) {
          if (value instanceof Primitive) {
              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(new Primitive(value.value0));
          };
          if (value instanceof LambdaRef) {
              var filtered = Data_Foldable.foldl(Data_List.foldableList)(function (m) {
                  return function (key) {
                      return Data_StrMap["delete"](key)(m);
                  };
              })(strmap)(value.value0);
              return Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(LambdaRef.create(value.value0))(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_StrMap.traversableStrMap)(value.value1)(function (prop) {
                  return replace(filtered)(prop);
              })))(replace(filtered)(value.value2));
          };
          if (value instanceof NativeFunction) {
              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(new NativeFunction(value.value0));
          };
          if (value instanceof ErrorRef) {
              return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new ErrorRef(value.value0));
          };
          if (value instanceof ObjectRef) {
              return Data_Functor.map(Control_Monad_Eff.functorEff)(ObjectRef.create)(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(value.value0)(function (v) {
                  return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Tuple.Tuple.create(v.value0))(replace(strmap)(v.value1));
              }));
          };
          if (value instanceof OperatorRef) {
              return Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(OperatorRef.create(value.value0))(replace(strmap)(value.value1)))(replace(strmap)(value.value2));
          };
          if (value instanceof ConditionalRef) {
              return Control_Apply.apply(Control_Monad_Eff.applyEff)(Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(ConditionalRef.create)(replace(strmap)(value.value0)))(replace(strmap)(value.value1)))(replace(strmap)(value.value2));
          };
          if (value instanceof IdentifierRef) {
              var $64 = Data_StrMap.lookup(value.value0)(strmap);
              if ($64 instanceof Data_Maybe.Nothing) {
                  return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new IdentifierRef(value.value0));
              };
              if ($64 instanceof Data_Maybe.Just) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)($64.value0);
              };
              throw new Error("Failed pattern match at LazyScript.Reducer line 246, column 23 - line 248, column 32: " + [ $64.constructor.name ]);
          };
          if (value instanceof CallRef) {
              return Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(CallRef.create)(replace(strmap)(value.value0)))(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(value.value1)(replace(strmap)));
          };
          if (value instanceof DotRef) {
              return Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(DotRef.create)(replace(strmap)(value.value0)))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(value.value1));
          };
          if (value instanceof SeqRef) {
              return Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(SeqRef.create)(replace(strmap)(value.value0)))(replace(strmap)(value.value1));
          };
          if (value instanceof Ref) {
              return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_ST.readSTRef(value.value0))(replace(strmap));
          };
          if (value instanceof Scope) {
              return Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Scope.create)(Data_Traversable.traverse(Data_StrMap.traversableStrMap)(Control_Monad_Eff.applicativeEff)(replace(strmap))(value.value0)))(replace(strmap)(value.value1));
          };
          throw new Error("Failed pattern match at LazyScript.Reducer line 237, column 24 - line 253, column 85: " + [ value.constructor.name ]);
      };
  };
  var isNormalForm = function (expr) {
      if (expr instanceof Primitive) {
          return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(true);
      };
      if (expr instanceof LambdaRef) {
          return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(true);
      };
      if (expr instanceof NativeFunction) {
          return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(true);
      };
      if (expr instanceof ErrorRef) {
          return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(true);
      };
      if (expr instanceof ObjectRef) {
          return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Foldable.and(Data_List.foldableList)(Data_BooleanAlgebra.booleanAlgebraBoolean))(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(expr.value0)(function (v) {
              return isNormalForm(v.value1);
          }));
      };
      if (expr instanceof Ref) {
          return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_ST.readSTRef(expr.value0))(isNormalForm);
      };
      return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(false);
  };
  var flat = function (__copy_v) {
      var v = __copy_v;
      tco: while (true) {
          if (v instanceof Ref) {
              return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_ST.readSTRef(v.value0))(flat);
          };
  ...
  var reduce = function (env) {
      return function (ref) {
          if (ref instanceof Primitive) {
              return Control_Monad_Eff_Exception["throw"]("Finish");
          };
          if (ref instanceof LambdaRef) {
              return Control_Monad_Eff_Exception["throw"]("Finish");
          };
          if (ref instanceof NativeFunction) {
              return Control_Monad_Eff_Exception["throw"]("Finish");
          };
          if (ref instanceof ErrorRef) {
              return Control_Monad_Eff_Exception["throw"]("Finish");
          };
          if (ref instanceof ObjectRef) {
              return function __do() {
                  var v = isNormalForm(new ObjectRef(ref.value0))();
                  if (v) {
                      return Control_Monad_Eff_Exception["throw"]("Finish")();
                  };
                  if (!v) {
                      var v1 = Data_List.foldM(Control_Monad_Eff.monadEff)(function (v1) {
                          return function (v2) {
                              if (v1.value0) {
                                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(new Data_Tuple.Tuple(true, new Data_List.Cons(new Data_Tuple.Tuple(v2.value0, v2.value1), v1.value1)));
                              };
                              if (!v1.value0) {
                                  return function __do() {
                                      var v4 = isNormalForm(v2.value1)();
                                      if (v4) {
                                          return new Data_Tuple.Tuple(false, new Data_List.Cons(new Data_Tuple.Tuple(v2.value0, v2.value1), v1.value1));
                                      };
                                      if (!v4) {
                                          var v5 = reduce(env)(v2.value1)();
                                          return new Data_Tuple.Tuple(true, new Data_List.Cons(new Data_Tuple.Tuple(v2.value0, v5), v1.value1));
                                      };
                                      throw new Error("Failed pattern match at LazyScript.Reducer line 130, column 25 - line 134, column 79: " + [ v4.constructor.name ]);
                                  };
                              };
                              throw new Error("Failed pattern match at LazyScript.Reducer line 125, column 94 - line 134, column 79: " + [ v1.value0.constructor.name ]);
                          };
                      })(new Data_Tuple.Tuple(false, Data_List.Nil.value))(ref.value0)();
                      if (v1.value0) {
                          return new ObjectRef(v1.value1);
                      };
                      if (!v1.value0) {
                          return Control_Monad_Eff_Exception["throw"]("Finish")();
                      };
                      throw new Error("Failed pattern match at LazyScript.Reducer line 136, column 17 - line 138, column 5: " + [ v1.value0.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at LazyScript.Reducer line 122, column 9 - line 138, column 5: " + [ v.constructor.name ]);
              };
          };
          if (ref instanceof OperatorRef) {
              return function __do() {
                  var v = flat(ref.value1)();
                  var v1 = flat(ref.value2)();
                  if (ref.value0 === "==" && v instanceof ObjectRef) {
                      return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Function.apply(Primitive.create)(Data_Foreign.toForeign(false)))();
                  };
                  if (ref.value0 === "==" && v1 instanceof ObjectRef) {
                      return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Function.apply(Primitive.create)(Data_Foreign.toForeign(false)))();
                  };
                  if (v instanceof Primitive && v1 instanceof Primitive) {
                      return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Function.apply(Primitive.create)(LazyScript_Foreign.operate(ref.value0)(v.value0)(v1.value0)))();
                  };
                  var v2 = isNormalForm(ref.value1)();
                  var $131 = !v2;
                  if ($131) {
                      return Data_Functor.map(Control_Monad_Eff.functorEff)(function (lhs$prime1) {
                          return new OperatorRef(ref.value0, lhs$prime1, ref.value2);
                      })(reduce(env)(ref.value1))();
                  };
                  if (!$131) {
                      return Data_Functor.map(Control_Monad_Eff.functorEff)(function (rhs$prime1) {
                          return new OperatorRef(ref.value0, ref.value1, rhs$prime1);
                      })(reduce(env)(ref.value2))();
                  };
                  throw new Error("Failed pattern match at LazyScript.Reducer line 148, column 17 - line 150, column 82: " + [ $131.constructor.name ]);
              };
          };
          if (ref instanceof ConditionalRef) {
              return function __do() {
                  var v = flat(ref.value0)();
                  if (v instanceof Primitive) {
                      if (LazyScript_Foreign.foreignToBoolean(v.value0)) {
                          return ref.value1;
                      };
                      if (Data_Boolean.otherwise) {
                          return ref.value2;
                  ...
                  return Control_Apply.apply(Control_Monad_Eff.applyEff)(Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(ConditionalRef.create)(reduce(env)(ref.value0)))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(ref.value1)))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(ref.value2))();
              };
          };
          if (ref instanceof IdentifierRef) {
              var $141 = Data_StrMap.lookup(ref.value0)(env);
              if ($141 instanceof Data_Maybe.Nothing) {
                  return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Function.apply(ErrorRef.create)("Can't find variable \"" + (ref.value0 + "\"")));
              };
              if ($141 instanceof Data_Maybe.Just) {
                  return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)($141.value0);
              };
              throw new Error("Failed pattern match at LazyScript.Reducer line 159, column 23 - line 161, column 32: " + [ $141.constructor.name ]);
          };
          if (ref instanceof CallRef && (ref.value0 instanceof DotRef && (ref.value0.value0 instanceof IdentifierRef && (ref.value1 instanceof Data_List.Cons && ref.value1.value1 instanceof Data_List.Nil)))) {
              return function __do() {
                  var v = isNormalForm(ref.value1.value0)();
                  if (v) {
                      var v1 = LazyScript_Foreign.invokeForeignFunction(ref.value0.value0.value0)(ref.value0.value1)([ expressionToForeign(ref.value1.value0) ])();
                      var $147 = Control_Alt.alt(Data_Either.altEither)(Control_Alt.alt(Data_Either.altEither)(Control_Alt.alt(Data_Either.altEither)(Data_Functor["void"](Data_Either.functorEither)(Data_Foreign.readInt(v1)))(Data_Functor["void"](Data_Either.functorEither)(Data_Foreign.readNumber(v1))))(Data_Functor["void"](Data_Either.functorEither)(Data_Foreign.readString(v1))))(Data_Functor["void"](Data_Either.functorEither)(Data_Foreign.readBoolean(v1)));
                      if ($147 instanceof Data_Either.Left) {
                          return new Primitive(Data_Foreign_Undefined.writeUndefined);
                      };
                      if ($147 instanceof Data_Either.Right) {
                          return new Primitive(v1);
                      };
                      throw new Error("Failed pattern match at LazyScript.Reducer line 168, column 17 - line 170, column 50: " + [ $147.constructor.name ]);
                  };
                  if (!v) {
                      var v1 = reduce(env)(ref.value1.value0)();
                      return new CallRef(new DotRef(new IdentifierRef(ref.value0.value0.value0), ref.value0.value1), new Data_List.Cons(v1, Data_List.Nil.value));
                  };
                  throw new Error("Failed pattern match at LazyScript.Reducer line 165, column 9 - line 173, column 72: " + [ v.constructor.name ]);
              };
          };
          if (ref instanceof CallRef && ref.value0 instanceof LambdaRef) {
              if (Data_List.length(ref.value1) === Data_List.length(ref.value0.value0)) {
                  return function __do() {
                      var v = Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(ref.value1)(function (p) {
                          return function __do() {
                              var v = isNormalForm(p)();
                              if (v) {
                                  return p;
                              };
                              if (!v) {
                                  var v1 = Control_Monad_ST.newSTRef(p)();
                                  return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Function.apply(Scope.create(env))(new Ref(v1)))();
                              };
                              throw new Error("Failed pattern match at LazyScript.Reducer line 178, column 53 - line 180, column 81: " + [ v.constructor.name ]);
                          };
                      })();
                      var table = Data_StrMap.fromFoldable(Data_List.foldableList)(Data_List.zip(ref.value0.value0)(v));
                      var v1 = Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_StrMap.traversableStrMap)(ref.value0.value1)(function (value) {
                          return function __do() {
                              var v1 = isNormalForm(value)();
                              if (v1) {
                                  return value;
                              };
                              if (!v1) {
                                  var v2 = Control_Monad_ST.newSTRef(value)();
                                  return replace(table)(new Ref(v2))();
                              };
                              throw new Error("Failed pattern match at LazyScript.Reducer line 184, column 53 - line 186, column 78: " + [ v1.constructor.name ]);
                          };
                      })();
                      var v2 = replace(table)(ref.value0.value2)();
                      var $167 = Data_StrMap.isEmpty(ref.value0.value1);
                      if ($167) {
                          return v2;
                      };
                      if (!$167) {
                          return new Scope(v1, v2);
                      };
                      throw new Error("Failed pattern match at LazyScript.Reducer line 188, column 49 - line 188, column 111: " + [ $167.constructor.name ]);
                  };
              };
              if (Data_Boolean.otherwise) {
                  return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Function.apply(ErrorRef.create)("Invalid argument number, expected " + (Data_Show.show(Data_Show.showInt)(Data_List.length(ref.value0.value0)) + (", found " + Data_Show.show(Data_Show.showInt)(Data_List.length(ref.value1))))));
              };
          };
          if (ref instanceof CallRef) {
              return function __do() {
                  var v = reduce(env)(ref.value0)();
          ...
          if (ref instanceof DotRef) {
              return function __do() {
                  ...
                  if (v instanceof ObjectRef) {
                      var $178 = Data_Tuple.lookup(Data_List.foldableList)(Data_Eq.eqString)(ref.value1)(v.value0);
                      if ($178 instanceof Data_Maybe.Nothing) {
                          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new ErrorRef("No props"))();
                      };
                      if ($178 instanceof Data_Maybe.Just) {
                          return $178.value0;
                      };
                      throw new Error("Failed pattern match at LazyScript.Reducer line 199, column 33 - line 201, column 40: " + [ $178.constructor.name ]);
                  };
                  var v1 = isNormalForm(v)();
                  if (v1) {
                      return ref;
                  };
                  if (!v1) {
                      return Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(DotRef.create)(reduce(env)(ref.value0)))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(ref.value1))();
                  };
                  throw new Error("Failed pattern match at LazyScript.Reducer line 204, column 17 - line 206, column 65: " + [ v1.constructor.name ]);
              };
          };
          if (ref instanceof SeqRef) {
              return function __do() {
                  var v = isNormalForm(ref.value0)();
                  if (v) {
                      return ref.value1;
                  };
                  if (!v) {
                      return Data_Functor.map(Control_Monad_Eff.functorEff)(function (lhs$prime) {
                          return new SeqRef(lhs$prime, ref.value1);
                      })(reduce(env)(ref.value0))();
                  };
                  throw new Error("Failed pattern match at LazyScript.Reducer line 210, column 9 - line 212, column 62: " + [ v.constructor.name ]);
              };
          };
          if (ref instanceof Ref) {
              return function __do() {
                  var v = Control_Monad_ST.readSTRef(ref.value0)();
                  var v2 = isNormalForm(v)();
                  if (v2) {
                      return v;
                  };
                  if (!v2) {
                      var v3 = reduce(env)(v)();
                      Control_Monad_ST.writeSTRef(ref.value0)(v3)();
                      var v4 = isNormalForm(v3)();
                      if (v4) {
                          return v3;
                      };
                      if (!v4) {
                          return new Ref(ref.value0);
                      };
                      throw new Error("Failed pattern match at LazyScript.Reducer line 223, column 17 - line 225, column 39: " + [ v4.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at LazyScript.Reducer line 217, column 9 - line 225, column 39: " + [ v2.constructor.name ]);
              };
          };
          if (ref instanceof Scope) {
              return function __do() {
                  var v = isNormalForm(ref.value1)();
                  if (v) {
                      return ref.value1;
                  };
                  if (!v) {
                      var v1 = reduce(Data_StrMap.union(ref.value0)(env))(ref.value1)();
                      var v2 = isNormalForm(v1)();
                      if (v2) {
                          return v1;
                      };
                      if (!v2) {
                          return new Scope(ref.value0, v1);
                      };
                      throw new Error("Failed pattern match at LazyScript.Reducer line 234, column 17 - line 234, column 51: " + [ v2.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at LazyScript.Reducer line 229, column 9 - line 234, column 51: " + [ v.constructor.name ]);
              };
          };
          throw new Error("Failed pattern match at LazyScript.Reducer line 115, column 18 - line 234, column 51: " + [ ref.constructor.name ]);
      };
  };
  var encode = function (expression) {
      if (expression instanceof LazyScript_Types.Int) {
          return Data_Function.apply(Primitive.create)(Data_Foreign.toForeign(expression.value0));
      };
      ...
      if (expression instanceof LazyScript_Types.Null) {
          return new Primitive(Data_Foreign_Null.writeNull);
      };
      if (expression instanceof LazyScript_Types.Undefined) {
          return new Primitive(Data_Foreign_Undefined.writeUndefined);
      };
      if (expression instanceof LazyScript_Types.Lambda) {
          return new LambdaRef(expression.value0, Data_Functor.map(Data_StrMap.functorStrMap)(encode)(Data_StrMap.fromFoldable(Data_List.foldableList)(expression.value1)), encode(expression.value2));
      };
      if (expression instanceof LazyScript_Types["Error"]) {
          return new ErrorRef(expression.value0);
      };
      if (expression instanceof LazyScript_Types["Object"]) {
          return new ObjectRef(Data_Functor.map(Data_List.functorList)(function (v) {
              return new Data_Tuple.Tuple(v.value0, encode(v.value1));
          })(expression.value0));
      };
      ...
      if (expression instanceof LazyScript_Types.Conditional) {
          return new ConditionalRef(encode(expression.value0), encode(expression.value1), encode(expression.value2));
      };
      ...
      if (expression instanceof LazyScript_Types.Dot) {
          return new DotRef(encode(expression.value0), expression.value1);
      };
      if (expression instanceof LazyScript_Types.Seq) {
          return new SeqRef(encode(expression.value0), encode(expression.value1));
      };
      throw new Error("Failed pattern match at LazyScript.Reducer line 47, column 21 - line 62, column 51: " + [ expression.constructor.name ]);
  };
  var encodeEnv = function (env) {
      return Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(env)(function (v) {
          var encoded = encode(v.value1);
          return function __do() {
              var v1 = isNormalForm(encoded)();
              if (v1) {
                  return new Data_Tuple.Tuple(v.value0, encoded);
              };
              if (!v1) {
                  var v2 = Control_Monad_ST.newSTRef(encoded)();
                  return new Data_Tuple.Tuple(v.value0, new Ref(v2));
              };
              throw new Error("Failed pattern match at LazyScript.Reducer line 108, column 5 - line 112, column 44: " + [ v1.constructor.name ]);
          };
      });
  };
  var decode = function (ref) {
      if (ref instanceof Primitive) {
          if (Data_Foreign.isNull(ref.value0)) {
              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(LazyScript_Types.Null.value);
          };
          if (Data_Foreign.isUndefined(ref.value0)) {
              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(LazyScript_Types.Undefined.value);
          };
          if (Data_Boolean.otherwise) {
              var readPrimitive = function (fgn1) {
                  return Control_Alt.alt(Data_Either.altEither)(Control_Alt.alt(Data_Either.altEither)(Control_Alt.alt(Data_Either.altEither)(Control_Alt.alt(Data_Either.altEither)(Data_Functor.map(Data_Either.functorEither)((LazyScript_Types["String"]).create)(Data_Foreign.readString(fgn1)))(Data_Functor.map(Data_Either.functorEither)(LazyScript_Types.Int.create)(Data_Foreign.readInt(fgn1))))(Data_Functor.map(Data_Either.functorEither)((LazyScript_Types["Number"]).create)(Data_Foreign.readNumber(fgn1))))(Data_Functor.map(Data_Either.functorEither)((LazyScript_Types["String"]).create)(Data_Foreign.readString(fgn1))))(Data_Functor.map(Data_Either.functorEither)((LazyScript_Types["Boolean"]).create)(Data_Foreign.readBoolean(fgn1)));
              };
              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)((function () {
                  var $236 = readPrimitive(ref.value0);
                  if ($236 instanceof Data_Either.Left) {
                      return LazyScript_Types.Undefined.value;
                  };
                  if ($236 instanceof Data_Either.Right) {
                      return $236.value0;
                  };
                  throw new Error("Failed pattern match at LazyScript.Reducer line 76, column 17 - line 78, column 32: " + [ $236.constructor.name ]);
              })());
          };
      };
      if (ref instanceof LambdaRef) {
          return Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(LazyScript_Types.Lambda.create(ref.value0))(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_StrMap.toList)(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_StrMap.traversableStrMap)(ref.value1)(decode))))(decode(ref.value2));
      };
      if (ref instanceof NativeFunction) {
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new LazyScript_Types["Error"]("[[Native Function]]"));
      };
      if (ref instanceof ErrorRef) {
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new LazyScript_Types["Error"](ref.value0));
      };
      if (ref instanceof ObjectRef) {
          return Data_Functor.map(Control_Monad_Eff.functorEff)((LazyScript_Types["Object"]).create)(Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(ref.value0)(function (v) {
              return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Tuple.Tuple.create(v.value0))(decode(v.value1));
          }));
      };
      if (ref instanceof OperatorRef) {
      ...
      if (ref instanceof ConditionalRef) {
          return Control_Apply.apply(Control_Monad_Eff.applyEff)(Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(LazyScript_Types.Conditional.create)(decode(ref.value0)))(decode(ref.value1)))(decode(ref.value2));
      };
      if (ref instanceof IdentifierRef) {
      ...
      if (ref instanceof DotRef) {
          return Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(LazyScript_Types.Dot.create)(decode(ref.value0)))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(ref.value1));
      };
      if (ref instanceof SeqRef) {
          return Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(LazyScript_Types.Seq.create)(decode(ref.value0)))(decode(ref.value1));
      };
      if (ref instanceof Ref) {
          return Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Monad_ST.readSTRef(ref.value0))(decode);
      };
      if (ref instanceof Scope) {
          return decode(ref.value1);
      };
      throw new Error("Failed pattern match at LazyScript.Reducer line 65, column 14 - line 90, column 31: " + [ ref.constructor.name ]);
  };
  var createGraph = function (program) {
      return function __do() {
          var v = Data_Functor.map(Control_Monad_Eff.functorEff)(Data_StrMap.fromFoldable(Data_List.foldableList))(encodeEnv(LazyScript_Types.assignments(program)))();
          return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(Data_Functor.map(Data_List.functorList)(function (expr) {
              return new Scope(v, encode(expr));
          })(LazyScript_Types.expressions(program)))();
      };
  };
...
})(PS["LazyScript.Reducer"] = PS["LazyScript.Reducer"] || {});
(function(exports) {
  // Generated by psc version 0.9.3
  "use strict";
  var Data_List = PS["Data.List"];
  ...
  var Evaluated = (function () {
      function Evaluated(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      Evaluated.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new Evaluated(value0, value1, value2);
              };
          };
      };
      return Evaluated;
...
(function(exports) {
  ...
  var printExpression = function (v) {
      ...
      if (v instanceof LazyScript_Types.Operator && (v.value0 === "*" && (v.value1 instanceof LazyScript_Types.Operator && (v.value1.value0 === "+" && (v.value2 instanceof LazyScript_Types.Operator && v.value2.value0 === "+"))))) {
          return "(" + (printExpression(v.value1) + (") " + ("*" + (" (" + (printExpression(v.value2) + ")")))));
      };
      ...
      if (v instanceof LazyScript_Types.Call && v.value0 instanceof LazyScript_Types.Lambda) {
          return "(" + (printExpression(new LazyScript_Types.Lambda(v.value0.value0, v.value0.value1, v.value0.value2)) + (")(" + (Data_Foldable.intercalate(Data_List.foldableList)(Data_Monoid.monoidString)(", ")(Data_Functor.map(Data_List.functorList)(printExpression)(v.value1)) + ")")));
      };
      ...
      if (v instanceof LazyScript_Types.Lambda) {
          if (Data_List["null"](v.value1)) {
              return "(" + (Data_Foldable.intercalate(Data_List.foldableList)(Data_Monoid.monoidString)(", ")(v.value0) + (") => " + printExpression(v.value2)));
          };
          if (Data_Boolean.otherwise) {
              return "(" + (Data_Foldable.intercalate(Data_List.foldableList)(Data_Monoid.monoidString)(", ")(v.value0) + (") => {" + (Data_Foldable.foldMap(Data_List.foldableList)(Data_Monoid.monoidString)(function (v1) {
                  return v1.value0 + (" = " + (printExpression(v1.value1) + "; "));
              })(v.value1) + ("return " + (printExpression(v.value2) + " }")))));
          };
      };
      ...
      throw new Error("Failed pattern match at LazyScript.Printer line 10, column 1 - line 10, column 37: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var Text_Format = PS["Text.Format"];
  var Halogen_HTML_Elements = PS["Halogen.HTML.Elements"];
  ...
  var render = function (state) {
      return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.header_([ Halogen_HTML_Elements.h1_([ Halogen_HTML.text("LazyScript Evaluater") ]) ]), Halogen_HTML_Elements_Indexed.p([ Data_Function.apply(Halogen_HTML_Properties_Indexed.class_)(Halogen_HTML_Core.className("content")) ])([ Halogen_HTML_Elements_Indexed.div([ Data_Function.apply(Halogen_HTML_Properties_Indexed.class_)(Halogen_HTML_Core.className("buttons")) ])([ Halogen_HTML_Elements_Indexed.button([ Halogen_HTML_Events_Indexed.onClick(Halogen_HTML_Events.input_(LazyScript_Playground_Types.Evaluate.create)) ])([ Halogen_HTML.text("Evaluate") ]), Halogen_HTML_Elements_Indexed.select([ Halogen_HTML_Events_Indexed.onValueChange(Halogen_HTML_Events.input(LazyScript_Playground_Types.Example.create)) ])(Data_Functor.map(Data_Functor.functorArray)(function (v) {
          ...
          throw new Error("Failed pattern match at LazyScript.Playground.Render line 41, column 9 - line 43, column 194: " + [ state.parseError.constructor.name ]);
          ...
          if (state.result instanceof LazyScript_Playground_Types.Evaluated) {
              return [ Halogen_HTML_Elements.p_([ Data_Function.apply(Halogen_HTML.text)("time: " + (Text_Format.format(Text_Format.formatInt)(Text_Format.precision(1))(state.result.value2) + "msecs.")), Data_Function.apply(Halogen_HTML.text)("/ reductions: " + Data_Show.show(Data_Show.showInt)(state.result.value1)) ]), Halogen_HTML_Elements_Indexed.pre([  ])([ Halogen_HTML.text(state.result.value0) ]) ];
          };
          ...
          throw new Error("Failed pattern match at LazyScript.Playground.Render line 44, column 9 - line 52, column 58: " + [ state.result.constructor.name ]);
      })()) ]) ]);
  };
...
(function(exports) {
  ...
  var Text_Parsing_Parser = PS["Text.Parsing.Parser"];
  var LazyScript_Types = PS["LazyScript.Types"];
  var LazyScript_Reducer = PS["LazyScript.Reducer"];
  var LazyScript_Parser = PS["LazyScript.Parser"];
  var LazyScript_Playground_Types = PS["LazyScript.Playground.Types"];
  ...
  var maximumReductionCount = 1000;
  var ui = (function () {
      var $$eval = function (v) {
          if (v instanceof LazyScript_Playground_Types.Change) {
              return Data_Functor.voidRight(Control_Monad_Free.freeFunctor)(v.value1)(Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.get)(function (v1) {
                  return Halogen_Query.modify(function (v2) {
                      var $20 = {};
                      for (var $21 in v2) {
                          if (v2.hasOwnProperty($21)) {
                              $20[$21] = v2[$21];
                          };
                      };
                      $20.source = v.value0;
                      $20.parseError = (function () {
                          var $17 = Text_Parsing_Parser.runParser(v.value0)(LazyScript_Parser.program);
                          if ($17 instanceof Data_Either.Left) {
                              return new Data_Maybe.Just($17.value0);
                          };
                          if ($17 instanceof Data_Either.Right) {
                              return Data_Maybe.Nothing.value;
                          };
                          throw new Error("Failed pattern match at LazyScript.Playground.Main line 50, column 26 - line 52, column 34: " + [ $17.constructor.name ]);
                      })();
                      return $20;
                  });
              }));
          ...
          if (v instanceof LazyScript_Playground_Types.Example) {
              return Data_Functor.voidRight(Control_Monad_Free.freeFunctor)(v.value1)((function () {
                  var $25 = Data_Tuple.lookup(Data_Foldable.foldableArray)(Data_Eq.eqString)(v.value0)(LazyScript_Playground_Samples.samples);
                  ...
                  if ($25 instanceof Data_Maybe.Just) {
                      return $$eval(new LazyScript_Playground_Types.Change(Data_String.trim($25.value0), v.value1));
                  };
                  throw new Error("Failed pattern match at LazyScript.Playground.Main line 56, column 9 - line 58, column 58: " + [ $25.constructor.name ]);
              })());
          };
          if (v instanceof LazyScript_Playground_Types.Evaluate) {
              return Data_Functor.voidRight(Control_Monad_Free.freeFunctor)(v.value0)(Control_Bind.bind(Control_Monad_Free.freeBind)(Halogen_Query.get)(function (v1) {
                  var $30 = Text_Parsing_Parser.runParser(v1.source)(LazyScript_Parser.program);
                  if ($30 instanceof Data_Either.Left) {
                      return Halogen_Query.modify(function (v2) {
                          ...
                          $31.parseError = new Data_Maybe.Just($30.value0);
                          return $31;
                      });
                  };
                  if ($30 instanceof Data_Either.Right) {
                      var body = LazyScript_Types.expressions($30.value0);
                      var $35 = Data_List["null"](body);
                      if ($35) {
                          return Halogen_Query.modify(function (v2) {
                              var $36 = {};
                              for (var $37 in v2) {
                                  if (v2.hasOwnProperty($37)) {
                                      $36[$37] = v2[$37];
                                  };
                              };
                              $36.result = new LazyScript_Playground_Types.RuntimeError("No expressions to evaluate");
                              return $36;
                          });
                      };
                      if (!$35) {
                          return Data_Functor["void"](Control_Monad_Free.freeFunctor)(Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Function.apply(Halogen_Query.liftH)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(LazyScript_Foreign.now)))(function (v2) {
                              return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Function.apply(Halogen_Query.liftH)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(function __do() {
                                  var v3 = LazyScript_Reducer.createGraph($30.value0)();
                                  return Data_Traversable["for"](Control_Monad_Eff.applicativeEff)(Data_List.traversableList)(v3)(function (expression$prime) {
                                      return function __do() {
                                          var v4 = LazyScript_Reducer.decode(expression$prime)();
                                          return Control_Monad_Rec_Class.tailRecM(Control_Monad_Rec_Class.monadRecEff)(function (v5) {
                                              var $43 = maximumReductionCount < Data_List.length(v5.value1);
                                              if ($43) {
                                                  return Data_Function.apply(Control_Applicative.pure(Control_Monad_Eff.applicativeEff))(new Data_Either.Right(v5.value1));
                                              };
                                              if (!$43) {
                                                  return function __do() {
                                                      var v6 = Data_Function.apply(Control_Monad_Eff_Exception["try"])(LazyScript_Reducer.reduce(Data_StrMap.empty)(v5.value0))();
                                                      if (v6 instanceof Data_Either.Left) {
                                                          return new Data_Either.Right(v5.value1);
                                                      };
                                                      if (v6 instanceof Data_Either.Right) {
                                                          var v7 = LazyScript_Reducer.decode(v6.value0)();
                                                          return new Data_Either.Left(new Data_Tuple.Tuple(v6.value0, new Data_List.Cons(v7, v5.value1)));
                                                      };
                                                      throw new Error("Failed pattern match at LazyScript.Playground.Main line 80, column 41 - line 84, column 79: " + [ v6.constructor.name ]);
                                                  };
                                              };
                                              throw new Error("Failed pattern match at LazyScript.Playground.Main line 76, column 62 - line 84, column 79: " + [ $43.constructor.name ]);
                                          })(new Data_Tuple.Tuple(expression$prime, Data_List.singleton(v4)))();
                                      };
                                  })();
                              })))(function (v3) {
                                  return Control_Bind.bind(Control_Monad_Free.freeBind)(Data_Function.apply(Halogen_Query.liftH)(Data_Function.apply(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff))(LazyScript_Foreign.now)))(function (v4) {
                                      var count = Data_Foldable.sum(Data_List.foldableList)(Data_Semiring.semiringInt)(Data_Functor.map(Data_List.functorList)(Data_List.length)(v3)) - 1;
                                      var txt = Data_Function.apply(Data_Foldable.intercalate(Data_List.foldableList)(Data_Monoid.monoidString)("\n\n"))(Data_Functor.map(Data_List.functorList)(function (ys) {
                                          return "  " + Data_Foldable.intercalate(Data_List.foldableList)(Data_Monoid.monoidString)("\n= ")(Data_Functor.map(Data_List.functorList)(LazyScript_Printer.printExpression)(Data_List.reverse(ys)));
                                      })(v3));
                                      return Halogen_Query.modify(function (state1) {
                                          var $53 = {};
                                          for (var $54 in state1) {
                                              if (state1.hasOwnProperty($54)) {
                                                  $53[$54] = state1[$54];
                                              };
                                          };
                                          $53.result = new LazyScript_Playground_Types.Evaluated(txt, count, v4 - v2);
                                          return $53;
                                      });
                                  });
                              });
                      ...
                      throw new Error("Failed pattern match at LazyScript.Playground.Main line 67, column 17 - line 90, column 98: " + [ $35.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at LazyScript.Playground.Main line 62, column 9 - line 90, column 98: " + [ $30.constructor.name ]);
              }));
          };
          throw new Error("Failed pattern match at LazyScript.Playground.Main line 46, column 5 - line 53, column 11: " + [ v.constructor.name ]);
      };
  ...
  exports["main"] = main;
  exports["maximumReductionCount"] = maximumReductionCount;
  exports["ui"] = ui;

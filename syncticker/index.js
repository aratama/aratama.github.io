...
(function(exports) {
  ...
  var render = function (state) {
      ...
      var renderHelp = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ SyncTicker_Classes.help, (function () {
          ...
          throw new Error("Failed pattern match at SyncTicker.Render line 114, column 69 - line 117, column 13: " + [ state.serverState.constructor.name ]);
      })()) ]) ]) ]);
      ...
      var digit = function (n) {
          return function (shift) {
              var buttonDisabled = (function () {
                  var $3 = !state.active && state.count === state.max;
                  if ($3) {
                      return SyncTicker_Classes.empty;
                  };
      ...
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(SyncTicker_Classes.root) ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.classes([ SyncTicker_Classes.display, (function () {
          ...
          var $5 = state.active || state.count === state.max;
          if ($5) {
              return SyncTicker_Classes.disabled;
          };
          return SyncTicker_Classes.empty;
  ...
  var $$eval = (function () {
      ...
      var updateServerValue = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
          return Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))((function () {
              ...
              throw new Error("Failed pattern match at SyncTicker.UI line 205, column 17 - line 211, column 23: " + [ v.firebase.constructor.name ]);
          })());
      });
      return function (v) {
          if (v instanceof SyncTicker_Type.Initialize) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(function __do() {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at SyncTicker.UI line 45, column 9 - line 55, column 68: " + [ v2.constructor.name ]);
                  })())(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v2) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Web_Firebase4.initializeApp({
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                                  ...
                                  $73.firebase = new Data_Maybe.Just(v3);
                                  return $73;
                              })()))(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      if (v.value0 instanceof Data_Maybe.Just) {
                          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                              ...
                              $82.serverState = v.value0;
                              $82.count = v.value0.value0.count;
                              $82.max = v.value0.value0.max;
                              $82.active = v.value0.value0.active;
                              return $82;
                          })());
                      };
                      throw new Error("Failed pattern match at SyncTicker.UI line 77, column 9 - line 87, column 18: " + [ v.value0.constructor.name ]);
                  })())(function () {
          ...
          if (v instanceof SyncTicker_Type.Backward) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      ...
                      $90.count = Data_Ord.max(Data_Ord.ordInt)(-5999 | 0)(Data_Ord.min(Data_Ord.ordInt)(5999)(v1.max));
                      $90.active = false;
                      return $90;
                  })()))(function () {
          ...
          if (v instanceof SyncTicker_Type.Play) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(value))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(updateServerValue)(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                      });
                  });
          ...
          if (v instanceof SyncTicker_Type.Tick) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(v1.active)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      var $110 = {};
                      for (var $111 in v1) {
                      ...
                      $110.count = Data_Ord.max(Data_Ord.ordInt)(-5999 | 0)(Data_Ord.min(Data_Ord.ordInt)(5999)(v1.count - 1 | 0));
                      return $110;
                  })())))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  });
          ...
          if (v instanceof SyncTicker_Type.Adjust) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at SyncTicker.UI line 133, column 9 - line 148, column 43: " + [ v1.active.constructor.name ]);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)((function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))((function () {
                          ...
                          throw new Error("Failed pattern match at SyncTicker.UI line 158, column 17 - line 164, column 23: " + [ v1.firebase.constructor.name ]);
                      })()))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                      });
                  });
          ...
          throw new Error("Failed pattern match at SyncTicker.UI line 34, column 8 - line 170, column 18: " + [ v.constructor.name ]);
      };
  })();
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (v) {
      return Control_Bind.bind(Control_Monad_Aff.bindAff)(Halogen_VDom_Driver.runUI(SyncTicker_UI.ui)("cats")(v))(function (v1) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Aff.bindAff)(v1.query(Halogen_Query.action(SyncTicker_Type.Initialize.create)))(function () {
              return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Control_Monad_Eff_Timer.setInterval(1000)(Halogen_Aff_Util.runHalogenAff(v1.query(Halogen_Query.action(SyncTicker_Type.Tick.create))))))(function (v2) {
                  return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(Data_Unit.unit);
              });
          });
      });
